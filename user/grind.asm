...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      8e:	13650513          	addi	a0,a0,310 # 11c0 <filter_is_blocked+0x28>
      92:	349000ef          	jal	bda <mkdir>
  if(chdir("grindir") != 0){
      96:	00001517          	auipc	a0,0x1
      9a:	12a50513          	addi	a0,a0,298 # 11c0 <filter_is_blocked+0x28>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      b0:	11c50513          	addi	a0,a0,284 # 11c8 <filter_is_blocked+0x30>
  ...
  chdir("/");
      ...
      ca:	12a50513          	addi	a0,a0,298 # 11f0 <filter_is_blocked+0x58>
      ce:	315000ef          	jal	be2 <chdir>
      d2:	00001997          	auipc	s3,0x1
      d6:	12e98993          	addi	s3,s3,302 # 1200 <filter_is_blocked+0x68>
      da:	c489                	beqz	s1,e4 <go+0x70>
      dc:	00001997          	auipc	s3,0x1
      e0:	11c98993          	addi	s3,s3,284 # 11f8 <filter_is_blocked+0x60>
  uint64 iters = 0;
      e4:	4481                	li	s1,0
  int fd = -1;
      e6:	5a7d                	li	s4,-1
      e8:	00001917          	auipc	s2,0x1
      ec:	3e890913          	addi	s2,s2,1000 # 14d0 <filter_is_blocked+0x338>
    ...
    if(what == 1){
      ...
      fa:	11250513          	addi	a0,a0,274 # 1208 <filter_is_blocked+0x70>
    ...
    int what = rand() % 23;
     ...
     148:	0d450513          	addi	a0,a0,212 # 1218 <filter_is_blocked+0x80>
     ...
     15a:	0b250513          	addi	a0,a0,178 # 1208 <filter_is_blocked+0x70>
     15e:	265000ef          	jal	bc2 <unlink>
     162:	b755                	j	106 <go+0x92>
    } else if(what == 4){
      if(chdir("grindir") != 0){
     164:	00001517          	auipc	a0,0x1
     168:	05c50513          	addi	a0,a0,92 # 11c0 <filter_is_blocked+0x28>
     ...
     176:	0be50513          	addi	a0,a0,190 # 1230 <filter_is_blocked+0x98>
     17a:	249000ef          	jal	bc2 <unlink>
      chdir("/");
     17e:	00001517          	auipc	a0,0x1
     182:	07250513          	addi	a0,a0,114 # 11f0 <filter_is_blocked+0x58>
     186:	25d000ef          	jal	be2 <chdir>
     18a:	bfb5                	j	106 <go+0x92>
        printf("grind: chdir grindir failed\n");
     18c:	00001517          	auipc	a0,0x1
     190:	03c50513          	addi	a0,a0,60 # 11c8 <filter_is_blocked+0x30>
     ...
     1ac:	09050513          	addi	a0,a0,144 # 1238 <filter_is_blocked+0xa0>
     ...
     1c6:	08650513          	addi	a0,a0,134 # 1248 <filter_is_blocked+0xb0>
     ...
     1fe:	00e50513          	addi	a0,a0,14 # 1208 <filter_is_blocked+0x70>
     202:	1d9000ef          	jal	bda <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     206:	20200593          	li	a1,514
     20a:	00001517          	auipc	a0,0x1
     20e:	05650513          	addi	a0,a0,86 # 1260 <filter_is_blocked+0xc8>
     212:	1a1000ef          	jal	bb2 <open>
     216:	185000ef          	jal	b9a <close>
      unlink("a/a");
     21a:	00001517          	auipc	a0,0x1
     21e:	05650513          	addi	a0,a0,86 # 1270 <filter_is_blocked+0xd8>
     222:	1a1000ef          	jal	bc2 <unlink>
     226:	b5c5                	j	106 <go+0x92>
    } else if(what == 10){
      mkdir("/../b");
     228:	00001517          	auipc	a0,0x1
     22c:	05050513          	addi	a0,a0,80 # 1278 <filter_is_blocked+0xe0>
     230:	1ab000ef          	jal	bda <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     234:	20200593          	li	a1,514
     238:	00001517          	auipc	a0,0x1
     23c:	04850513          	addi	a0,a0,72 # 1280 <filter_is_blocked+0xe8>
     240:	173000ef          	jal	bb2 <open>
     244:	157000ef          	jal	b9a <close>
      unlink("b/b");
     248:	00001517          	auipc	a0,0x1
     24c:	04850513          	addi	a0,a0,72 # 1290 <filter_is_blocked+0xf8>
     250:	173000ef          	jal	bc2 <unlink>
     254:	bd4d                	j	106 <go+0x92>
    } else if(what == 11){
      unlink("b");
     256:	00001517          	auipc	a0,0x1
     25a:	04250513          	addi	a0,a0,66 # 1298 <filter_is_blocked+0x100>
     25e:	165000ef          	jal	bc2 <unlink>
      link("../grindir/./../a", "../b");
     262:	00001597          	auipc	a1,0x1
     266:	fce58593          	addi	a1,a1,-50 # 1230 <filter_is_blocked+0x98>
     26a:	00001517          	auipc	a0,0x1
     26e:	03650513          	addi	a0,a0,54 # 12a0 <filter_is_blocked+0x108>
     272:	161000ef          	jal	bd2 <link>
     276:	bd41                	j	106 <go+0x92>
    } else if(what == 12){
      unlink("../grindir/../a");
     278:	00001517          	auipc	a0,0x1
     27c:	04050513          	addi	a0,a0,64 # 12b8 <filter_is_blocked+0x120>
     280:	143000ef          	jal	bc2 <unlink>
      link(".././b", "/grindir/../a");
     284:	00001597          	auipc	a1,0x1
     288:	fb458593          	addi	a1,a1,-76 # 1238 <filter_is_blocked+0xa0>
     28c:	00001517          	auipc	a0,0x1
     290:	03c50513          	addi	a0,a0,60 # 12c8 <filter_is_blocked+0x130>
     ...
     2b4:	02050513          	addi	a0,a0,32 # 12d0 <filter_is_blocked+0x138>
     ...
     2e6:	fee50513          	addi	a0,a0,-18 # 12d0 <filter_is_blocked+0x138>
     ...
     2f0:	083000ef          	jal	b72 <exit>
      ...
      sbrk(6011);
     2f4:	6505                	lui	a0,0x1
     2f6:	77b50513          	addi	a0,a0,1915 # 177b <digits+0x24b>
     ...
     32a:	fca50513          	addi	a0,a0,-54 # 12f0 <filter_is_blocked+0x158>
     ...
     34a:	fa250513          	addi	a0,a0,-94 # 12e8 <filter_is_blocked+0x150>
     ...
     360:	f7450513          	addi	a0,a0,-140 # 12d0 <filter_is_blocked+0x138>
     ...
     372:	f9250513          	addi	a0,a0,-110 # 1300 <filter_is_blocked+0x168>
     ...
     3a4:	f3050513          	addi	a0,a0,-208 # 12d0 <filter_is_blocked+0x138>
     ...
     3e4:	f3850513          	addi	a0,a0,-200 # 1318 <filter_is_blocked+0x180>
     ...
     400:	f3458593          	addi	a1,a1,-204 # 1330 <filter_is_blocked+0x198>
     ...
     430:	f0c50513          	addi	a0,a0,-244 # 1338 <filter_is_blocked+0x1a0>
     434:	37f000ef          	jal	fb2 <printf>
     438:	bfe9                	j	412 <go+0x39e>
          printf("grind: pipe read failed\n");
     43a:	00001517          	auipc	a0,0x1
     43e:	f1e50513          	addi	a0,a0,-226 # 1358 <filter_is_blocked+0x1c0>
     442:	371000ef          	jal	fb2 <printf>
     446:	b7c5                	j	426 <go+0x3b2>
        printf("grind: fork failed\n");
     448:	00001517          	auipc	a0,0x1
     44c:	e8850513          	addi	a0,a0,-376 # 12d0 <filter_is_blocked+0x138>
     ...
     470:	e7c50513          	addi	a0,a0,-388 # 12e8 <filter_is_blocked+0x150>
     474:	74e000ef          	jal	bc2 <unlink>
        mkdir("a");
     478:	00001517          	auipc	a0,0x1
     47c:	e7050513          	addi	a0,a0,-400 # 12e8 <filter_is_blocked+0x150>
     480:	75a000ef          	jal	bda <mkdir>
        chdir("a");
     484:	00001517          	auipc	a0,0x1
     488:	e6450513          	addi	a0,a0,-412 # 12e8 <filter_is_blocked+0x150>
     48c:	756000ef          	jal	be2 <chdir>
        unlink("../a");
     490:	00001517          	auipc	a0,0x1
     494:	ee850513          	addi	a0,a0,-280 # 1378 <filter_is_blocked+0x1e0>
     498:	72a000ef          	jal	bc2 <unlink>
        fd = open("x", O_CREATE|O_RDWR);
     49c:	20200593          	li	a1,514
     4a0:	00001517          	auipc	a0,0x1
     4a4:	e9050513          	addi	a0,a0,-368 # 1330 <filter_is_blocked+0x198>
     4a8:	70a000ef          	jal	bb2 <open>
        unlink("x");
     4ac:	00001517          	auipc	a0,0x1
     4b0:	e8450513          	addi	a0,a0,-380 # 1330 <filter_is_blocked+0x198>
     ...
     4c2:	e1250513          	addi	a0,a0,-494 # 12d0 <filter_is_blocked+0x138>
     ...
     4d4:	eb050513          	addi	a0,a0,-336 # 1380 <filter_is_blocked+0x1e8>
     ...
     4e4:	ea050513          	addi	a0,a0,-352 # 1380 <filter_is_blocked+0x1e8>
     ...
     4f8:	e3c58593          	addi	a1,a1,-452 # 1330 <filter_is_blocked+0x198>
     ...
     532:	e5250513          	addi	a0,a0,-430 # 1380 <filter_is_blocked+0x1e8>
     536:	68c000ef          	jal	bc2 <unlink>
     53a:	b6f1                	j	106 <go+0x92>
        printf("grind: create c failed\n");
     53c:	00001517          	auipc	a0,0x1
     540:	e4c50513          	addi	a0,a0,-436 # 1388 <filter_is_blocked+0x1f0>
     ...
     552:	e5250513          	addi	a0,a0,-430 # 13a0 <filter_is_blocked+0x208>
     ...
     564:	e5850513          	addi	a0,a0,-424 # 13b8 <filter_is_blocked+0x220>
     ...
     578:	e5c50513          	addi	a0,a0,-420 # 13d0 <filter_is_blocked+0x238>
     ...
     58a:	e7250513          	addi	a0,a0,-398 # 13f8 <filter_is_blocked+0x260>
     ...
     636:	e6658593          	addi	a1,a1,-410 # 1498 <filter_is_blocked+0x300>
     ...
     656:	e4e50513          	addi	a0,a0,-434 # 14a0 <filter_is_blocked+0x308>
     ...
     668:	cb458593          	addi	a1,a1,-844 # 1318 <filter_is_blocked+0x180>
     66c:	4509                	li	a0,2
     ...
     67c:	ca058593          	addi	a1,a1,-864 # 1318 <filter_is_blocked+0x180>
     680:	4509                	li	a0,2
     ...
     6bc:	d6858593          	addi	a1,a1,-664 # 1420 <filter_is_blocked+0x288>
     6c0:	4509                	li	a0,2
     ...
     6d8:	d6478793          	addi	a5,a5,-668 # 1438 <filter_is_blocked+0x2a0>
     6dc:	faf43423          	sd	a5,-88(s0)
     6e0:	00001797          	auipc	a5,0x1
     6e4:	d6078793          	addi	a5,a5,-672 # 1440 <filter_is_blocked+0x2a8>
     6e8:	faf43823          	sd	a5,-80(s0)
     6ec:	fa043c23          	sd	zero,-72(s0)
        exec("grindir/../echo", args);
     6f0:	fa840593          	addi	a1,s0,-88
     6f4:	00001517          	auipc	a0,0x1
     6f8:	d5450513          	addi	a0,a0,-684 # 1448 <filter_is_blocked+0x2b0>
     6fc:	4ae000ef          	jal	baa <exec>
        fprintf(2, "grind: echo: not found\n");
     700:	00001597          	auipc	a1,0x1
     704:	d5858593          	addi	a1,a1,-680 # 1458 <filter_is_blocked+0x2c0>
     708:	4509                	li	a0,2
     ...
     718:	bbc58593          	addi	a1,a1,-1092 # 12d0 <filter_is_blocked+0x138>
     71c:	4509                	li	a0,2
     ...
     74c:	cd858593          	addi	a1,a1,-808 # 1420 <filter_is_blocked+0x288>
     750:	4509                	li	a0,2
     ...
     77c:	ca858593          	addi	a1,a1,-856 # 1420 <filter_is_blocked+0x288>
     780:	4509                	li	a0,2
     ...
     798:	cdc78793          	addi	a5,a5,-804 # 1470 <filter_is_blocked+0x2d8>
     79c:	faf43423          	sd	a5,-88(s0)
     7a0:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     7a4:	fa840593          	addi	a1,s0,-88
     7a8:	00001517          	auipc	a0,0x1
     7ac:	cd050513          	addi	a0,a0,-816 # 1478 <filter_is_blocked+0x2e0>
     7b0:	3fa000ef          	jal	baa <exec>
        fprintf(2, "grind: cat: not found\n");
     7b4:	00001597          	auipc	a1,0x1
     7b8:	ccc58593          	addi	a1,a1,-820 # 1480 <filter_is_blocked+0x2e8>
     7bc:	4509                	li	a0,2
     ...
     7cc:	b0858593          	addi	a1,a1,-1272 # 12d0 <filter_is_blocked+0x138>
     7d0:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     7e8:	b0450513          	addi	a0,a0,-1276 # 12e8 <filter_is_blocked+0x150>
     7ec:	3d6000ef          	jal	bc2 <unlink>
  unlink("b");
     7f0:	00001517          	auipc	a0,0x1
     7f4:	aa850513          	addi	a0,a0,-1368 # 1298 <filter_is_blocked+0x100>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     82a:	aaa50513          	addi	a0,a0,-1366 # 12d0 <filter_is_blocked+0x138>
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     84e:	629c                	ld	a5,0(a3)
     850:	6709                	lui	a4,0x2
     852:	c0970713          	addi	a4,a4,-1015 # 1c09 <digits+0x6d9>
    ...
    printf("grind: fork failed\n");
     ...
     864:	a7050513          	addi	a0,a0,-1424 # 12d0 <filter_is_blocked+0x138>
...
0000000000000c22 <setfilter_child>:
...
printint(int fd, long long xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     c66:	8ce50513          	addi	a0,a0,-1842 # 1530 <digits>
     c6a:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     efc:	638b8b93          	addi	s7,s7,1592 # 1530 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     ...
     f5e:	56e90913          	addi	s2,s2,1390 # 14c8 <filter_is_blocked+0x330>
        for(; *s; s++)
...
000000000000115e <filter_enable>:
...
int filter_is_blocked(int sys_num) {
    ...
    11a2:	84aa                	mv	s1,a0
    long current_mask = getfilter();
    11a4:	a77ff0ef          	jal	c1a <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
    11a8:	40955533          	sra	a0,a0,s1
}
    11ac:	8905                	andi	a0,a0,1
