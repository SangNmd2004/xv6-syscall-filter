...
ls(char *path)
{
  ...
  f8:	a8c50513          	addi	a0,a0,-1396 # b80 <filter_is_blocked+0x5a>
 ...
 122:	a3258593          	addi	a1,a1,-1486 # b50 <filter_is_blocked+0x2a>
 126:	4509                	li	a0,2
 ...
 134:	a3858593          	addi	a1,a1,-1480 # b68 <filter_is_blocked+0x42>
 138:	4509                	li	a0,2
 ...
 15e:	a3650513          	addi	a0,a0,-1482 # b90 <filter_is_blocked+0x6a>
 ...
 1a2:	9e2a0a13          	addi	s4,s4,-1566 # b80 <filter_is_blocked+0x5a>
        printf("ls: cannot stat %s\n", buf);
 1a6:	00001a97          	auipc	s5,0x1
 1aa:	9c2a8a93          	addi	s5,s5,-1598 # b68 <filter_is_blocked+0x42>
...
main(int argc, char *argv[])
{
 ...
 25e:	94e50513          	addi	a0,a0,-1714 # ba8 <filter_is_blocked+0x82>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 5f4:	5c850513          	addi	a0,a0,1480 # bb8 <digits>
 5f8:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 88a:	332b8b93          	addi	s7,s7,818 # bb8 <digits>
 ...
 8ec:	2c890913          	addi	s2,s2,712 # bb0 <filter_is_blocked+0x8a>
        for(; *s; s++)
...
0000000000000aec <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 af4:	aadff0ef          	jal	5a0 <setfilter>
}
 af8:	60a2                	ld	ra,8(sp)
 afa:	6402                	ld	s0,0(sp)
...
0000000000000b00 <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 b0c:	a9dff0ef          	jal	5a8 <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 b10:	4785                	li	a5,1
 b12:	009797b3          	sll	a5,a5,s1
 b16:	8d5d                	or	a0,a0,a5
 b18:	a89ff0ef          	jal	5a0 <setfilter>
}
 b1c:	60e2                	ld	ra,24(sp)
 b1e:	6442                	ld	s0,16(sp)
 b20:	64a2                	ld	s1,8(sp)
 b22:	6105                	addi	sp,sp,32
 b24:	8082                	ret

0000000000000b26 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 b30:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 b32:	a77ff0ef          	jal	5a8 <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 b36:	40955533          	sra	a0,a0,s1
}
 b3a:	8905                	andi	a0,a0,1
