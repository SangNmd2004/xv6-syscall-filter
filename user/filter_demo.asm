...
main(void)
{
  ...
  printf("TEST_ERRNO: Dang bat bo loc (cam WRITE)...\n");
   ...
   c:	9f850513          	addi	a0,a0,-1544 # a00 <filter_debug_status+0x94>
  10:	734000ef          	jal	744 <printf>

  if(setfilter(mask) < 0){
  14:	01800537          	lui	a0,0x1800
  18:	0511                	addi	a0,a0,4 # 1800004 <base+0x17fdff4>
  ...
  2a:	a3a58593          	addi	a1,a1,-1478 # a60 <filter_debug_status+0xf4>
  2e:	4505                	li	a0,1
  ...
  3c:	a4050513          	addi	a0,a0,-1472 # a78 <filter_debug_status+0x10c>
  ...
  54:	9e050513          	addi	a0,a0,-1568 # a30 <filter_debug_status+0xc4>
  ...
  66:	a3650513          	addi	a0,a0,-1482 # a98 <filter_debug_status+0x12c>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3f8:	7ac50513          	addi	a0,a0,1964 # ba0 <digits>
 3fc:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 68e:	516b8b93          	addi	s7,s7,1302 # ba0 <digits>
 ...
 6f0:	3e490913          	addi	s2,s2,996 # ad0 <filter_debug_status+0x164>
        for(; *s; s++)
...
free(void *ap)
{
 ...
 780:	00002797          	auipc	a5,0x2
 784:	8807b783          	ld	a5,-1920(a5) # 2000 <freep>
 ...
 7ac:	00e6ea63          	bltu	a3,a4,7c0 <free+0x4a>
{
 ...
 7e8:	e394                	sd	a3,0(a5)
    ...
    p->s.ptr = bp;
  freep = p;
 7ea:	00002717          	auipc	a4,0x2
 7ee:	80f73b23          	sd	a5,-2026(a4) # 2000 <freep>
}
 7f2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 818:	7ec53503          	ld	a0,2028(a0) # 2000 <freep>
 ...
 848:	7bc90913          	addi	s2,s2,1980 # 2000 <freep>
  if(p == SBRK_ERROR)
 84c:	5afd                	li	s5,-1
 ...
 85c:	7b878793          	addi	a5,a5,1976 # 2010 <base>
 ...
 8d2:	72a73923          	sd	a0,1842(a4) # 2000 <freep>
      return (void*)(p + 1);
...
int filter_apply(long blacklist_mask) {
 ...
 8f8:	fff54513          	not	a0,a0
 8fc:	aa9ff0ef          	jal	3a4 <setfilter>
}
 900:	60a2                	ld	ra,8(sp)
 902:	6402                	ld	s0,0(sp)
...
0000000000000908 <filter_block_syscall>:
...
int filter_block_syscall(int sys_num) {
 ...
 914:	a99ff0ef          	jal	3ac <getfilter>
    // Tắt bit tương ứng với syscall đó trong whitelist
    return setfilter(current_mask & ~BLOCK(sys_num));
 918:	4785                	li	a5,1
 91a:	009797b3          	sll	a5,a5,s1
 91e:	fff7c793          	not	a5,a5
 922:	8d7d                	and	a0,a0,a5
 924:	a81ff0ef          	jal	3a4 <setfilter>
}
...
int filter_reset(void) {
 ...
 93a:	557d                	li	a0,-1
 93c:	a69ff0ef          	jal	3a4 <setfilter>
}
 940:	60a2                	ld	ra,8(sp)
 942:	6402                	ld	s0,0(sp)
...
0000000000000948 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 952:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 954:	a59ff0ef          	jal	3ac <getfilter>
    return !(current_mask & BLOCK(sys_num));
 958:	40955533          	sra	a0,a0,s1
 95c:	00154513          	xori	a0,a0,1
}
 960:	8905                	andi	a0,a0,1
...
000000000000096c <filter_debug_status>:
...
void filter_debug_status(void) {
 ...
 974:	1000                	addi	s0,sp,32
    long m = getfilter();
 976:	a37ff0ef          	jal	3ac <getfilter>
 97a:	84aa                	mv	s1,a0
    printf("\n[Sandbox Monitor]\n");
 97c:	00000517          	auipc	a0,0x0
 980:	18c50513          	addi	a0,a0,396 # b08 <filter_debug_status+0x19c>
 984:	dc1ff0ef          	jal	744 <printf>
    printf("Whitelist Mask: %ld\n", m);
 988:	85a6                	mv	a1,s1
 98a:	00000517          	auipc	a0,0x0
 98e:	19650513          	addi	a0,a0,406 # b20 <filter_debug_status+0x1b4>
 992:	db3ff0ef          	jal	744 <printf>
    printf("Security Level: %s\n", (m == 0xFFFFFFFFFFFFFFFFL) ? "LOW (Permissive)" : "HIGH (Restricted)");
 996:	57fd                	li	a5,-1
 998:	00000597          	auipc	a1,0x0
 99c:	15858593          	addi	a1,a1,344 # af0 <filter_debug_status+0x184>
 9a0:	02f48b63          	beq	s1,a5,9d6 <filter_debug_status+0x6a>
 9a4:	00000517          	auipc	a0,0x0
 9a8:	19450513          	addi	a0,a0,404 # b38 <filter_debug_status+0x1cc>
 9ac:	d99ff0ef          	jal	744 <printf>
    
    if(filter_is_blocked(SYS_open)) printf(" - File access: LOCKED\n");
 9b0:	453d                	li	a0,15
 9b2:	f97ff0ef          	jal	948 <filter_is_blocked>
 9b6:	e50d                	bnez	a0,9e0 <filter_debug_status+0x74>
    if(filter_is_blocked(SYS_fork)) printf(" - Process creation: LOCKED\n");
 9b8:	4505                	li	a0,1
 9ba:	f8fff0ef          	jal	948 <filter_is_blocked>
 9be:	e905                	bnez	a0,9ee <filter_debug_status+0x82>
    printf("------------------\n");
 9c0:	00000517          	auipc	a0,0x0
 9c4:	1c850513          	addi	a0,a0,456 # b88 <filter_debug_status+0x21c>
 9c8:	d7dff0ef          	jal	744 <printf>
 ...
 9d4:	8082                	ret
    printf("Security Level: %s\n", (m == 0xFFFFFFFFFFFFFFFFL) ? "LOW (Permissive)" : "HIGH (Restricted)");
 9d6:	00000597          	auipc	a1,0x0
 9da:	10258593          	addi	a1,a1,258 # ad8 <filter_debug_status+0x16c>
 9de:	b7d9                	j	9a4 <filter_debug_status+0x38>
    if(filter_is_blocked(SYS_open)) printf(" - File access: LOCKED\n");
 9e0:	00000517          	auipc	a0,0x0
 9e4:	17050513          	addi	a0,a0,368 # b50 <filter_debug_status+0x1e4>
 9e8:	d5dff0ef          	jal	744 <printf>
 9ec:	b7f1                	j	9b8 <filter_debug_status+0x4c>
    if(filter_is_blocked(SYS_fork)) printf(" - Process creation: LOCKED\n");
 9ee:	00000517          	auipc	a0,0x0
 9f2:	17a50513          	addi	a0,a0,378 # b68 <filter_debug_status+0x1fc>
 9f6:	d4fff0ef          	jal	744 <printf>
 9fa:	b7d9                	j	9c0 <filter_debug_status+0x54>
