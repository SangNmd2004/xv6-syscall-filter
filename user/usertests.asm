...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	93278793          	addi	a5,a5,-1742 # 7940 <filter_is_blocked+0x25a6>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	35a50513          	addi	a0,a0,858 # 53c0 <filter_is_blocked+0x26>
      ...
      94:	8082                	ret
{
      ...
      a4:	34050513          	addi	a0,a0,832 # 53e0 <filter_is_blocked+0x46>
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	33850513          	addi	a0,a0,824 # 53f8 <filter_is_blocked+0x5e>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	34250513          	addi	a0,a0,834 # 5418 <filter_is_blocked+0x7e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	30e50513          	addi	a0,a0,782 # 5400 <filter_is_blocked+0x66>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	32250513          	addi	a0,a0,802 # 5428 <filter_is_blocked+0x8e>
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     12c:	32850513          	addi	a0,a0,808 # 5450 <filter_is_blocked+0xb6>
     130:	495040ef          	jal	4dc4 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     134:	60100593          	li	a1,1537
     138:	00005517          	auipc	a0,0x5
     13c:	31850513          	addi	a0,a0,792 # 5450 <filter_is_blocked+0xb6>
     140:	475040ef          	jal	4db4 <open>
     144:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     146:	4611                	li	a2,4
     148:	00005597          	auipc	a1,0x5
     14c:	31858593          	addi	a1,a1,792 # 5460 <filter_is_blocked+0xc6>
     150:	445040ef          	jal	4d94 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     154:	40100593          	li	a1,1025
     158:	00005517          	auipc	a0,0x5
     15c:	2f850513          	addi	a0,a0,760 # 5450 <filter_is_blocked+0xb6>
     160:	455040ef          	jal	4db4 <open>
     164:	892a                	mv	s2,a0
  int n = write(fd1, "x", 1);
     166:	4605                	li	a2,1
     168:	00005597          	auipc	a1,0x5
     16c:	30058593          	addi	a1,a1,768 # 5468 <filter_is_blocked+0xce>
     170:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     180:	2d450513          	addi	a0,a0,724 # 5450 <filter_is_blocked+0xb6>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	2ca50513          	addi	a0,a0,714 # 5470 <filter_is_blocked+0xd6>
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	25450513          	addi	a0,a0,596 # 5498 <filter_is_blocked+0xfe>
     24c:	379040ef          	jal	4dc4 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	244a8a93          	addi	s5,s5,580 # 5498 <filter_is_blocked+0xfe>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	1e650513          	addi	a0,a0,486 # 54a8 <filter_is_blocked+0x10e>
     ...
     2e0:	1ec50513          	addi	a0,a0,492 # 54c8 <filter_is_blocked+0x12e>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	1e250513          	addi	a0,a0,482 # 54e0 <filter_is_blocked+0x146>
     306:	2bf040ef          	jal	4dc4 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	1d298993          	addi	s3,s3,466 # 54e0 <filter_is_blocked+0x146>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	19650513          	addi	a0,a0,406 # 54e0 <filter_is_blocked+0x146>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	10a58593          	addi	a1,a1,266 # 5468 <filter_is_blocked+0xce>
     366:	22f040ef          	jal	4d94 <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	19050513          	addi	a0,a0,400 # 5500 <filter_is_blocked+0x166>
    ...
    exit(1);
     ...
     386:	16650513          	addi	a0,a0,358 # 54e8 <filter_is_blocked+0x14e>
    ...
    printf("open junk failed\n");
     ...
     398:	15450513          	addi	a0,a0,340 # 54e8 <filter_is_blocked+0x14e>
  ...
  unlink("junk");
     ...
     3b0:	13450513          	addi	a0,a0,308 # 54e0 <filter_is_blocked+0x146>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	4b078793          	addi	a5,a5,1200 # 7940 <filter_is_blocked+0x25a6>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	052a0a13          	addi	s4,s4,82 # 5510 <filter_is_blocked+0x176>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	fd450513          	addi	a0,a0,-44 # 5518 <filter_is_blocked+0x17e>
     ...
     55e:	fd650513          	addi	a0,a0,-42 # 5530 <filter_is_blocked+0x196>
     ...
     574:	ff050513          	addi	a0,a0,-16 # 5560 <filter_is_blocked+0x1c6>
     ...
     586:	00e50513          	addi	a0,a0,14 # 5590 <filter_is_blocked+0x1f6>
     ...
     59c:	00850513          	addi	a0,a0,8 # 55a0 <filter_is_blocked+0x206>
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	38278793          	addi	a5,a5,898 # 7940 <filter_is_blocked+0x25a6>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	fdea0a13          	addi	s4,s4,-34 # 55d0 <filter_is_blocked+0x236>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	e6ea8a93          	addi	s5,s5,-402 # 5468 <filter_is_blocked+0xce>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	f5a50513          	addi	a0,a0,-166 # 55d8 <filter_is_blocked+0x23e>
     ...
     698:	f5c50513          	addi	a0,a0,-164 # 55f0 <filter_is_blocked+0x256>
     ...
     6aa:	eea50513          	addi	a0,a0,-278 # 5590 <filter_is_blocked+0x1f6>
     ...
     6bc:	f6850513          	addi	a0,a0,-152 # 5620 <filter_is_blocked+0x286>
     ...
     6d2:	f6a50513          	addi	a0,a0,-150 # 5638 <filter_is_blocked+0x29e>
...
00000000000006e0 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     6f8:	d5c50513          	addi	a0,a0,-676 # 5450 <filter_is_blocked+0xb6>
     6fc:	6c8040ef          	jal	4dc4 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     700:	60100593          	li	a1,1537
     704:	00005517          	auipc	a0,0x5
     708:	d4c50513          	addi	a0,a0,-692 # 5450 <filter_is_blocked+0xb6>
     70c:	6a8040ef          	jal	4db4 <open>
     710:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     712:	4611                	li	a2,4
     714:	00005597          	auipc	a1,0x5
     718:	d4c58593          	addi	a1,a1,-692 # 5460 <filter_is_blocked+0xc6>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	d2850513          	addi	a0,a0,-728 # 5450 <filter_is_blocked+0xb6>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	d0450513          	addi	a0,a0,-764 # 5450 <filter_is_blocked+0xb6>
     754:	660040ef          	jal	4db4 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	cf450513          	addi	a0,a0,-780 # 5450 <filter_is_blocked+0xb6>
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	f3a58593          	addi	a1,a1,-198 # 56c8 <filter_is_blocked+0x32e>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	c8c50513          	addi	a0,a0,-884 # 5450 <filter_is_blocked+0xb6>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	e7050513          	addi	a0,a0,-400 # 5668 <filter_is_blocked+0x2ce>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	e7c50513          	addi	a0,a0,-388 # 5688 <filter_is_blocked+0x2ee>
     814:	1a1040ef          	jal	51b4 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	e7c50513          	addi	a0,a0,-388 # 5698 <filter_is_blocked+0x2fe>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	e8850513          	addi	a0,a0,-376 # 56b8 <filter_is_blocked+0x31e>
     838:	17d040ef          	jal	51b4 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	e5850513          	addi	a0,a0,-424 # 5698 <filter_is_blocked+0x2fe>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	e7a50513          	addi	a0,a0,-390 # 56d0 <filter_is_blocked+0x336>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	e8450513          	addi	a0,a0,-380 # 56f0 <filter_is_blocked+0x356>
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	e7850513          	addi	a0,a0,-392 # 5710 <filter_is_blocked+0x376>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	e8c98993          	addi	s3,s3,-372 # 5738 <filter_is_blocked+0x39e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	ebca8a93          	addi	s5,s5,-324 # 5770 <filter_is_blocked+0x3d6>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	e2250513          	addi	a0,a0,-478 # 5710 <filter_is_blocked+0x376>
  ...
  if(unlink("small") < 0){
     ...
     922:	df250513          	addi	a0,a0,-526 # 5710 <filter_is_blocked+0x376>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	dd450513          	addi	a0,a0,-556 # 5718 <filter_is_blocked+0x37e>
    ...
    exit(1);
     ...
     95e:	dee50513          	addi	a0,a0,-530 # 5748 <filter_is_blocked+0x3ae>
     ...
     974:	e1050513          	addi	a0,a0,-496 # 5780 <filter_is_blocked+0x3e6>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	e2450513          	addi	a0,a0,-476 # 57a8 <filter_is_blocked+0x40e>
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	e3050513          	addi	a0,a0,-464 # 57c8 <filter_is_blocked+0x42e>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	e3450513          	addi	a0,a0,-460 # 57e0 <filter_is_blocked+0x446>
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	e2a50513          	addi	a0,a0,-470 # 5800 <filter_is_blocked+0x466>
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	de450513          	addi	a0,a0,-540 # 5800 <filter_is_blocked+0x466>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	dac50513          	addi	a0,a0,-596 # 5808 <filter_is_blocked+0x46e>
    ...
    exit(1);
     ...
     a76:	db650513          	addi	a0,a0,-586 # 5828 <filter_is_blocked+0x48e>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	dca50513          	addi	a0,a0,-566 # 5850 <filter_is_blocked+0x4b6>
  ...
  if(unlink("big") < 0){
     ...
     aaa:	d5a50513          	addi	a0,a0,-678 # 5800 <filter_is_blocked+0x466>
     ...
     ad0:	da450513          	addi	a0,a0,-604 # 5870 <filter_is_blocked+0x4d6>
     ...
     ae6:	db650513          	addi	a0,a0,-586 # 5898 <filter_is_blocked+0x4fe>
     ...
     afc:	db850513          	addi	a0,a0,-584 # 58b0 <filter_is_blocked+0x516>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	dcc50513          	addi	a0,a0,-564 # 58d8 <filter_is_blocked+0x53e>
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	dbe50513          	addi	a0,a0,-578 # 58f0 <filter_is_blocked+0x556>
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	dda58593          	addi	a1,a1,-550 # 5920 <filter_is_blocked+0x586>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	d9650513          	addi	a0,a0,-618 # 58f0 <filter_is_blocked+0x556>
  ...
  unlink("unlinkread");
     ...
     be6:	d0e50513          	addi	a0,a0,-754 # 58f0 <filter_is_blocked+0x556>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	d0250513          	addi	a0,a0,-766 # 5900 <filter_is_blocked+0x566>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	d1650513          	addi	a0,a0,-746 # 5928 <filter_is_blocked+0x58e>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	d2250513          	addi	a0,a0,-734 # 5948 <filter_is_blocked+0x5ae>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	d3650513          	addi	a0,a0,-714 # 5970 <filter_is_blocked+0x5d6>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	d4250513          	addi	a0,a0,-702 # 5990 <filter_is_blocked+0x5f6>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	d4e50513          	addi	a0,a0,-690 # 59b0 <filter_is_blocked+0x616>
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	d4e50513          	addi	a0,a0,-690 # 59d0 <filter_is_blocked+0x636>
     c8a:	13a040ef          	jal	4dc4 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	d4a50513          	addi	a0,a0,-694 # 59d8 <filter_is_blocked+0x63e>
     c96:	12e040ef          	jal	4dc4 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	d3250513          	addi	a0,a0,-718 # 59d0 <filter_is_blocked+0x636>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	c6e58593          	addi	a1,a1,-914 # 5920 <filter_is_blocked+0x586>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     cce:	d0e58593          	addi	a1,a1,-754 # 59d8 <filter_is_blocked+0x63e>
     cd2:	00005517          	auipc	a0,0x5
     cd6:	cfe50513          	addi	a0,a0,-770 # 59d0 <filter_is_blocked+0x636>
     cda:	0fa040ef          	jal	4dd4 <link>
     cde:	0c054963          	bltz	a0,db0 <linktest+0x13c>
  unlink("lf1");
     ce2:	00005517          	auipc	a0,0x5
     ce6:	cee50513          	addi	a0,a0,-786 # 59d0 <filter_is_blocked+0x636>
     cea:	0da040ef          	jal	4dc4 <unlink>
  if(open("lf1", 0) >= 0){
     cee:	4581                	li	a1,0
     cf0:	00005517          	auipc	a0,0x5
     cf4:	ce050513          	addi	a0,a0,-800 # 59d0 <filter_is_blocked+0x636>
     cf8:	0bc040ef          	jal	4db4 <open>
     cfc:	0c055463          	bgez	a0,dc4 <linktest+0x150>
  fd = open("lf2", 0);
     d00:	4581                	li	a1,0
     d02:	00005517          	auipc	a0,0x5
     d06:	cd650513          	addi	a0,a0,-810 # 59d8 <filter_is_blocked+0x63e>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     d32:	caa58593          	addi	a1,a1,-854 # 59d8 <filter_is_blocked+0x63e>
     d36:	852e                	mv	a0,a1
     d38:	09c040ef          	jal	4dd4 <link>
     d3c:	0c055263          	bgez	a0,e00 <linktest+0x18c>
  unlink("lf2");
     d40:	00005517          	auipc	a0,0x5
     d44:	c9850513          	addi	a0,a0,-872 # 59d8 <filter_is_blocked+0x63e>
     d48:	07c040ef          	jal	4dc4 <unlink>
  if(link("lf2", "lf1") >= 0){
     d4c:	00005597          	auipc	a1,0x5
     d50:	c8458593          	addi	a1,a1,-892 # 59d0 <filter_is_blocked+0x636>
     d54:	00005517          	auipc	a0,0x5
     d58:	c8450513          	addi	a0,a0,-892 # 59d8 <filter_is_blocked+0x63e>
     d5c:	078040ef          	jal	4dd4 <link>
     d60:	0a055a63          	bgez	a0,e14 <linktest+0x1a0>
  if(link(".", "lf1") >= 0){
     d64:	00005597          	auipc	a1,0x5
     d68:	c6c58593          	addi	a1,a1,-916 # 59d0 <filter_is_blocked+0x636>
     d6c:	00005517          	auipc	a0,0x5
     d70:	d7450513          	addi	a0,a0,-652 # 5ae0 <filter_is_blocked+0x746>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	c5650513          	addi	a0,a0,-938 # 59e0 <filter_is_blocked+0x646>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	c5a50513          	addi	a0,a0,-934 # 59f8 <filter_is_blocked+0x65e>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	c5e50513          	addi	a0,a0,-930 # 5a10 <filter_is_blocked+0x676>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	c6a50513          	addi	a0,a0,-918 # 5a30 <filter_is_blocked+0x696>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	c8650513          	addi	a0,a0,-890 # 5a60 <filter_is_blocked+0x6c6>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	c8a50513          	addi	a0,a0,-886 # 5a78 <filter_is_blocked+0x6de>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	c8e50513          	addi	a0,a0,-882 # 5a90 <filter_is_blocked+0x6f6>
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	ca250513          	addi	a0,a0,-862 # 5ab8 <filter_is_blocked+0x71e>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	cbe50513          	addi	a0,a0,-834 # 5ae8 <filter_is_blocked+0x74e>
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	cb498993          	addi	s3,s3,-844 # 5b08 <filter_is_blocked+0x76e>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	c8c50513          	addi	a0,a0,-884 # 5b18 <filter_is_blocked+0x77e>
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	c8450513          	addi	a0,a0,-892 # 5b38 <filter_is_blocked+0x79e>
     ebc:	709030ef          	jal	4dc4 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	c7450513          	addi	a0,a0,-908 # 5b38 <filter_is_blocked+0x79e>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	c5aa0a13          	addi	s4,s4,-934 # 5b38 <filter_is_blocked+0x79e>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	c0c50513          	addi	a0,a0,-1012 # 5b38 <filter_is_blocked+0x79e>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	bac50513          	addi	a0,a0,-1108 # 5b40 <filter_is_blocked+0x7a6>
    ...
    exit(1);
     ...
     fb2:	bb250513          	addi	a0,a0,-1102 # 5b60 <filter_is_blocked+0x7c6>
     ...
     fc6:	bc650513          	addi	a0,a0,-1082 # 5b88 <filter_is_blocked+0x7ee>
...
0000000000001000 <badarg>:
{
    ...
    101e:	3de98993          	addi	s3,s3,990 # 53f8 <filter_is_blocked+0x5e>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1094:	c4878793          	addi	a5,a5,-952 # 6cd8 <filter_is_blocked+0x193e>
  ...
  if(pid == 0){
    ...
    10e8:	85c78793          	addi	a5,a5,-1956 # 7940 <filter_is_blocked+0x25a6>
    ...
    110c:	2f050513          	addi	a0,a0,752 # 53f8 <filter_is_blocked+0x5e>
    ...
    1120:	b1450513          	addi	a0,a0,-1260 # 5c30 <filter_is_blocked+0x896>
    ...
    1138:	a7450513          	addi	a0,a0,-1420 # 5ba8 <filter_is_blocked+0x80e>
    ...
    1150:	a7c50513          	addi	a0,a0,-1412 # 5bc8 <filter_is_blocked+0x82e>
    ...
    116a:	a8250513          	addi	a0,a0,-1406 # 5be8 <filter_is_blocked+0x84e>
    ...
    1182:	a9250513          	addi	a0,a0,-1390 # 5c10 <filter_is_blocked+0x876>
    ...
    1194:	0a050513          	addi	a0,a0,160 # 7230 <filter_is_blocked+0x1e96>
  ...
  if(st != 747){
    ...
    11ce:	a8e50513          	addi	a0,a0,-1394 # 5c58 <filter_is_blocked+0x8be>
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	26450513          	addi	a0,a0,612 # 5450 <filter_is_blocked+0xb6>
  ...
  if(pid == 0){
    ...
    1216:	23ea0a13          	addi	s4,s4,574 # 5450 <filter_is_blocked+0xb6>
      int n = write(fd, "1234567890", 10);
    121a:	00005a97          	auipc	s5,0x5
    121e:	a9ea8a93          	addi	s5,s5,-1378 # 5cb8 <filter_is_blocked+0x91e>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    ...
    127a:	a1250513          	addi	a0,a0,-1518 # 5c88 <filter_is_blocked+0x8ee>
    ...
    128e:	a1650513          	addi	a0,a0,-1514 # 5ca0 <filter_is_blocked+0x906>
    ...
    12a4:	a2850513          	addi	a0,a0,-1496 # 5cc8 <filter_is_blocked+0x92e>
    ...
    12c2:	192a0a13          	addi	s4,s4,402 # 5450 <filter_is_blocked+0xb6>
    int n = write(fd, "xxx", 3);
    12c6:	00005a97          	auipc	s5,0x5
    12ca:	a22a8a93          	addi	s5,s5,-1502 # 5ce8 <filter_is_blocked+0x94e>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1304:	15050513          	addi	a0,a0,336 # 5450 <filter_is_blocked+0xb6>
  ...
  exit(xstatus);
    ...
    131a:	98a50513          	addi	a0,a0,-1654 # 5ca0 <filter_is_blocked+0x906>
    ...
    1330:	9c450513          	addi	a0,a0,-1596 # 5cf0 <filter_is_blocked+0x956>
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	0ae78793          	addi	a5,a5,174 # 53f8 <filter_is_blocked+0x5e>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00005797          	auipc	a5,0x5
    135a:	9ba78793          	addi	a5,a5,-1606 # 5d10 <filter_is_blocked+0x976>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00005517          	auipc	a0,0x5
    136a:	9b250513          	addi	a0,a0,-1614 # 5d18 <filter_is_blocked+0x97e>
  ...
  if(pid == 0) {
    ...
    138e:	98e50513          	addi	a0,a0,-1650 # 5d18 <filter_is_blocked+0x97e>
    ...
    13a6:	99650513          	addi	a0,a0,-1642 # 5d38 <filter_is_blocked+0x99e>
    ...
    13bc:	8d050513          	addi	a0,a0,-1840 # 5c88 <filter_is_blocked+0x8ee>
    ...
    13d0:	95450513          	addi	a0,a0,-1708 # 5d20 <filter_is_blocked+0x986>
    ...
    13e6:	01650513          	addi	a0,a0,22 # 53f8 <filter_is_blocked+0x5e>
  ...
  if(xstatus != 0)
    ...
    140e:	93e50513          	addi	a0,a0,-1730 # 5d48 <filter_is_blocked+0x9ae>
    ...
    1422:	94250513          	addi	a0,a0,-1726 # 5d60 <filter_is_blocked+0x9c6>
    1426:	58f030ef          	jal	51b4 <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00005517          	auipc	a0,0x5
    1432:	8ea50513          	addi	a0,a0,-1814 # 5d18 <filter_is_blocked+0x97e>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	37850513          	addi	a0,a0,888 # 57c8 <filter_is_blocked+0x42e>
    ...
    1468:	83c50513          	addi	a0,a0,-1988 # 5ca0 <filter_is_blocked+0x906>
  ...
  unlink("echo-ok");
    ...
    147a:	8a250513          	addi	a0,a0,-1886 # 5d18 <filter_is_blocked+0x97e>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	8dc50513          	addi	a0,a0,-1828 # 5d78 <filter_is_blocked+0x9de>
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	84850513          	addi	a0,a0,-1976 # 5d90 <filter_is_blocked+0x9f6>
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	7e650513          	addi	a0,a0,2022 # 5da8 <filter_is_blocked+0xa0e>
    ...
    15da:	7ea50513          	addi	a0,a0,2026 # 5dc0 <filter_is_blocked+0xa26>
    ...
    160a:	7d250513          	addi	a0,a0,2002 # 5dd8 <filter_is_blocked+0xa3e>
    ...
    1642:	7ba50513          	addi	a0,a0,1978 # 5df8 <filter_is_blocked+0xa5e>
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	5e850513          	addi	a0,a0,1512 # 5c88 <filter_is_blocked+0x8ee>
    ...
    16b8:	75c50513          	addi	a0,a0,1884 # 5e10 <filter_is_blocked+0xa76>
    ...
    16cc:	76050513          	addi	a0,a0,1888 # 5e28 <filter_is_blocked+0xa8e>
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	56450513          	addi	a0,a0,1380 # 5c88 <filter_is_blocked+0x8ee>
    ...
    1740:	54c50513          	addi	a0,a0,1356 # 5c88 <filter_is_blocked+0x8ee>
...
0000000000001752 <forkfork>:
{
    ...
    179e:	6ae50513          	addi	a0,a0,1710 # 5e48 <filter_is_blocked+0xaae>
    ...
    17a8:	5cc030ef          	jal	4d74 <exit>
{
    ...
    17da:	68250513          	addi	a0,a0,1666 # 5e58 <filter_is_blocked+0xabe>
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	a2050513          	addi	a0,a0,-1504 # 7230 <filter_is_blocked+0x1e96>
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	3f650513          	addi	a0,a0,1014 # 5c88 <filter_is_blocked+0x8ee>
    ...
    18ba:	46a50513          	addi	a0,a0,1130 # 5d20 <filter_is_blocked+0x986>
    ...
    1918:	56450513          	addi	a0,a0,1380 # 5e78 <filter_is_blocked+0xade>
    ...
    193c:	55850513          	addi	a0,a0,1368 # 5e90 <filter_is_blocked+0xaf6>
    ...
    198e:	52e50513          	addi	a0,a0,1326 # 5eb8 <filter_is_blocked+0xb1e>
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	a4450513          	addi	a0,a0,-1468 # 5468 <filter_is_blocked+0xce>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	a10b0b13          	addi	s6,s6,-1520 # 5468 <filter_is_blocked+0xce>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	480c0c13          	addi	s8,s8,1152 # 5ee0 <filter_is_blocked+0xb46>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	21c50513          	addi	a0,a0,540 # 5c88 <filter_is_blocked+0x8ee>
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	42450513          	addi	a0,a0,1060 # 5f30 <filter_is_blocked+0xb96>
    ...
    1b28:	3c450513          	addi	a0,a0,964 # 5ee8 <filter_is_blocked+0xb4e>
    ...
    1b3c:	3c850513          	addi	a0,a0,968 # 5f00 <filter_is_blocked+0xb66>
    ...
    1b50:	3cc50513          	addi	a0,a0,972 # 5f18 <filter_is_blocked+0xb7e>
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	09e50513          	addi	a0,a0,158 # 5c88 <filter_is_blocked+0x8ee>
    ...
    1c08:	35450513          	addi	a0,a0,852 # 5f58 <filter_is_blocked+0xbbe>
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	01650513          	addi	a0,a0,22 # 5c88 <filter_is_blocked+0x8ee>
    ...
    1c9a:	2e250513          	addi	a0,a0,738 # 5f78 <filter_is_blocked+0xbde>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	2aa50513          	addi	a0,a0,682 # 5f90 <filter_is_blocked+0xbf6>
    ...
    1cfe:	f8e50513          	addi	a0,a0,-114 # 5c88 <filter_is_blocked+0x8ee>
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	c1e78793          	addi	a5,a5,-994 # 7940 <filter_is_blocked+0x25a6>
  ...
  exit(0);
    ...
    1d8e:	22e50513          	addi	a0,a0,558 # 5fb8 <filter_is_blocked+0xc1e>
    ...
    1da2:	eea50513          	addi	a0,a0,-278 # 5c88 <filter_is_blocked+0x8ee>
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	42650513          	addi	a0,a0,1062 # 7230 <filter_is_blocked+0x1e96>
    ...
    1ea0:	13c50513          	addi	a0,a0,316 # 5fd8 <filter_is_blocked+0xc3e>
    ...
    1eb8:	61450513          	addi	a0,a0,1556 # 54c8 <filter_is_blocked+0x12e>
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1f2c:	db078793          	addi	a5,a5,-592 # 6cd8 <filter_is_blocked+0x193e>
  ...
  if(ret != -1){
    ...
    1f66:	08e50513          	addi	a0,a0,142 # 5ff0 <filter_is_blocked+0xc56>
    ...
    1f7c:	c3050513          	addi	a0,a0,-976 # 5ba8 <filter_is_blocked+0x80e>
    ...
    1f92:	c3a50513          	addi	a0,a0,-966 # 5bc8 <filter_is_blocked+0x82e>
    ...
    1faa:	c4250513          	addi	a0,a0,-958 # 5be8 <filter_is_blocked+0x84e>
    ...
    1fc0:	c5450513          	addi	a0,a0,-940 # 5c10 <filter_is_blocked+0x876>
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	03850513          	addi	a0,a0,56 # 6030 <filter_is_blocked+0xc96>
  ...
  if(n >= 0){
    ...
    2024:	03050513          	addi	a0,a0,48 # 6050 <filter_is_blocked+0xcb6>
    ...
    203a:	fc250513          	addi	a0,a0,-62 # 5ff8 <filter_is_blocked+0xc5e>
    ...
    204e:	fc650513          	addi	a0,a0,-58 # 6010 <filter_is_blocked+0xc76>
    ...
    2060:	fdc50513          	addi	a0,a0,-36 # 6038 <filter_is_blocked+0xc9e>
  ...
  unlink("rwsbrk");
    ...
    2078:	fbc50513          	addi	a0,a0,-68 # 6030 <filter_is_blocked+0xc96>
    207c:	549020ef          	jal	4dc4 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	54e50513          	addi	a0,a0,1358 # 55d0 <filter_is_blocked+0x236>
  ...
  if(n >= 0){
    ...
    20a8:	fdc50513          	addi	a0,a0,-36 # 6080 <filter_is_blocked+0xce6>
    ...
    20ba:	52250513          	addi	a0,a0,1314 # 55d8 <filter_is_blocked+0x23e>
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	f8850513          	addi	a0,a0,-120 # 60a8 <filter_is_blocked+0xd0e>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	f5850513          	addi	a0,a0,-168 # 60c8 <filter_is_blocked+0xd2e>
  ...
  if(c != a + 1){
    ...
    21c0:	f6c50513          	addi	a0,a0,-148 # 6128 <filter_is_blocked+0xd8e>
    ...
    21da:	f1250513          	addi	a0,a0,-238 # 60e8 <filter_is_blocked+0xd4e>
    ...
    21ee:	f1e50513          	addi	a0,a0,-226 # 6108 <filter_is_blocked+0xd6e>
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22d6:	e7650513          	addi	a0,a0,-394 # 6148 <filter_is_blocked+0xdae>
    ...
    22ea:	eaa50513          	addi	a0,a0,-342 # 6190 <filter_is_blocked+0xdf6>
    ...
    2302:	eb250513          	addi	a0,a0,-334 # 61b0 <filter_is_blocked+0xe16>
    ...
    231a:	eda50513          	addi	a0,a0,-294 # 61f0 <filter_is_blocked+0xe56>
    ...
    232e:	ef650513          	addi	a0,a0,-266 # 6220 <filter_is_blocked+0xe86>
    ...
    2346:	f1650513          	addi	a0,a0,-234 # 6258 <filter_is_blocked+0xebe>
...
0000000000002354 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2374:	f1050513          	addi	a0,a0,-240 # 6280 <filter_is_blocked+0xee6>
    2378:	23d020ef          	jal	4db4 <open>
    237c:	84aa                	mv	s1,a0
  unlink("sbrk");
    237e:	00004517          	auipc	a0,0x4
    2382:	f0250513          	addi	a0,a0,-254 # 6280 <filter_is_blocked+0xee6>
  ...
  if(pipe((int *) a) != 0){
    ...
    23c2:	eca50513          	addi	a0,a0,-310 # 6288 <filter_is_blocked+0xeee>
    ...
    23d6:	ece50513          	addi	a0,a0,-306 # 62a0 <filter_is_blocked+0xf06>
    ...
    23ea:	9aa50513          	addi	a0,a0,-1622 # 5d90 <filter_is_blocked+0x9f6>
...
00000000000023f8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    240c:	eb050513          	addi	a0,a0,-336 # 62b8 <filter_is_blocked+0xf1e>
  ...
  close(fd);
    ...
    2444:	86050513          	addi	a0,a0,-1952 # 5ca0 <filter_is_blocked+0x906>
...
0000000000002452 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    247a:	dba50513          	addi	a0,a0,-582 # 7230 <filter_is_blocked+0x1e96>
  ...
  if(pid == 0){
    ...
    24b4:	d8050513          	addi	a0,a0,-640 # 7230 <filter_is_blocked+0x1e96>
  ...
  if(pid == 0){
    ...
    24f4:	d4050513          	addi	a0,a0,-704 # 7230 <filter_is_blocked+0x1e96>
...
00000000000025de <execout>:
{
  ...
  exit(0);
    ...
    2614:	c2050513          	addi	a0,a0,-992 # 7230 <filter_is_blocked+0x1e96>
    ...
    2654:	da850513          	addi	a0,a0,-600 # 53f8 <filter_is_blocked+0x5e>
    2658:	faa43c23          	sd	a0,-72(s0)
    265c:	00003797          	auipc	a5,0x3
    2660:	e0c78793          	addi	a5,a5,-500 # 5468 <filter_is_blocked+0xce>
...
000000000000267a <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    268a:	e0a50513          	addi	a0,a0,-502 # 6490 <filter_is_blocked+0x10f6>
    268e:	74e020ef          	jal	4ddc <mkdir>
    2692:	e555                	bnez	a0,273e <fourteen+0xc4>
  if(mkdir("12345678901234/123456789012345") != 0){
    2694:	00004517          	auipc	a0,0x4
    2698:	c5450513          	addi	a0,a0,-940 # 62e8 <filter_is_blocked+0xf4e>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26aa:	c9a50513          	addi	a0,a0,-870 # 6340 <filter_is_blocked+0xfa6>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26c0:	cfc50513          	addi	a0,a0,-772 # 63b8 <filter_is_blocked+0x101e>
  ...
  unlink("12345678901234");
    ...
    2744:	b8050513          	addi	a0,a0,-1152 # 62c0 <filter_is_blocked+0xf26>
    ...
    2758:	bb450513          	addi	a0,a0,-1100 # 6308 <filter_is_blocked+0xf6e>
    ...
    276c:	c0850513          	addi	a0,a0,-1016 # 6370 <filter_is_blocked+0xfd6>
    ...
    2780:	c6c50513          	addi	a0,a0,-916 # 63e8 <filter_is_blocked+0x104e>
    ...
    2794:	cb850513          	addi	a0,a0,-840 # 6448 <filter_is_blocked+0x10ae>
    ...
    27a8:	cfc50513          	addi	a0,a0,-772 # 64a0 <filter_is_blocked+0x1106>
...
00000000000027b6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27f0:	cec50513          	addi	a0,a0,-788 # 64d8 <filter_is_blocked+0x113e>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    281c:	cd050513          	addi	a0,a0,-816 # 64e8 <filter_is_blocked+0x114e>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    2892:	c4a50513          	addi	a0,a0,-950 # 64d8 <filter_is_blocked+0x113e>
    2896:	546020ef          	jal	4ddc <mkdir>
    289a:	12050063          	beqz	a0,29ba <diskfull+0x204>
  unlink("diskfulldir");
    289e:	00004517          	auipc	a0,0x4
    28a2:	c3a50513          	addi	a0,a0,-966 # 64d8 <filter_is_blocked+0x113e>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29c0:	b4c50513          	addi	a0,a0,-1204 # 6508 <filter_is_blocked+0x116e>
...
00000000000029ca <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2a26:	b1e50513          	addi	a0,a0,-1250 # 6540 <filter_is_blocked+0x11a6>
    ...
    2a3a:	b2250513          	addi	a0,a0,-1246 # 6558 <filter_is_blocked+0x11be>
    ...
    2a4e:	b3e50513          	addi	a0,a0,-1218 # 6588 <filter_is_blocked+0x11ee>
    ...
    2a62:	b5250513          	addi	a0,a0,-1198 # 65b0 <filter_is_blocked+0x1216>
...
0000000000002a70 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2ac2:	1ca50513          	addi	a0,a0,458 # 5c88 <filter_is_blocked+0x8ee>
    ...
    2ad6:	a6e50513          	addi	a0,a0,-1426 # 6540 <filter_is_blocked+0x11a6>
    ...
    2aea:	ae250513          	addi	a0,a0,-1310 # 65c8 <filter_is_blocked+0x122e>
    ...
    2afe:	a8e50513          	addi	a0,a0,-1394 # 6588 <filter_is_blocked+0x11ee>
...
0000000000002b1c <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b78:	9cc50513          	addi	a0,a0,-1588 # 6540 <filter_is_blocked+0x11a6>
    ...
    2b8c:	a6050513          	addi	a0,a0,-1440 # 65e8 <filter_is_blocked+0x124e>
    ...
    2ba0:	a6c50513          	addi	a0,a0,-1428 # 6608 <filter_is_blocked+0x126e>
    ...
    2bb4:	a7050513          	addi	a0,a0,-1424 # 6620 <filter_is_blocked+0x1286>
...
0000000000002bc2 <subdir>:
{
  ...
  unlink("ff");
    ...
    2bd4:	b9850513          	addi	a0,a0,-1128 # 6768 <filter_is_blocked+0x13ce>
    2bd8:	1ec020ef          	jal	4dc4 <unlink>
  if(mkdir("dd") != 0){
    2bdc:	00004517          	auipc	a0,0x4
    2be0:	a5c50513          	addi	a0,a0,-1444 # 6638 <filter_is_blocked+0x129e>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2bf4:	a6850513          	addi	a0,a0,-1432 # 6658 <filter_is_blocked+0x12be>
  ...
  write(fd, "ff", 2);
    ...
    2c08:	b6458593          	addi	a1,a1,-1180 # 6768 <filter_is_blocked+0x13ce>
  ...
  if(unlink("dd") >= 0){
    ...
    2c1a:	a2250513          	addi	a0,a0,-1502 # 6638 <filter_is_blocked+0x129e>
    2c1e:	1a6020ef          	jal	4dc4 <unlink>
    2c22:	2c055963          	bgez	a0,2ef4 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c26:	00004517          	auipc	a0,0x4
    2c2a:	a8a50513          	addi	a0,a0,-1398 # 66b0 <filter_is_blocked+0x1316>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c3e:	a9e50513          	addi	a0,a0,-1378 # 66d8 <filter_is_blocked+0x133e>
  ...
  write(fd, "FF", 2);
    ...
    2c52:	aba58593          	addi	a1,a1,-1350 # 6708 <filter_is_blocked+0x136e>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c66:	aae50513          	addi	a0,a0,-1362 # 6710 <filter_is_blocked+0x1376>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d4c:	99050513          	addi	a0,a0,-1648 # 66d8 <filter_is_blocked+0x133e>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d60:	b9450513          	addi	a0,a0,-1132 # 68f0 <filter_is_blocked+0x1556>
  ...
  if(unlink("dd") < 0){
    ...
    2ed2:	77250513          	addi	a0,a0,1906 # 6640 <filter_is_blocked+0x12a6>
    ...
    2ee6:	77e50513          	addi	a0,a0,1918 # 6660 <filter_is_blocked+0x12c6>
    ...
    2efa:	78a50513          	addi	a0,a0,1930 # 6680 <filter_is_blocked+0x12e6>
    ...
    2f0e:	7ae50513          	addi	a0,a0,1966 # 66b8 <filter_is_blocked+0x131e>
    ...
    2f22:	7ca50513          	addi	a0,a0,1994 # 66e8 <filter_is_blocked+0x134e>
    ...
    2f36:	7ee50513          	addi	a0,a0,2030 # 6720 <filter_is_blocked+0x1386>
    ...
    2f4a:	7fa50513          	addi	a0,a0,2042 # 6740 <filter_is_blocked+0x13a6>
    ...
    2f5e:	81650513          	addi	a0,a0,-2026 # 6770 <filter_is_blocked+0x13d6>
    ...
    2f72:	82a50513          	addi	a0,a0,-2006 # 6798 <filter_is_blocked+0x13fe>
    ...
    2f86:	83650513          	addi	a0,a0,-1994 # 67b8 <filter_is_blocked+0x141e>
    ...
    2f9a:	84a50513          	addi	a0,a0,-1974 # 67e0 <filter_is_blocked+0x1446>
    ...
    2fae:	85e50513          	addi	a0,a0,-1954 # 6808 <filter_is_blocked+0x146e>
    ...
    2fc2:	87a50513          	addi	a0,a0,-1926 # 6838 <filter_is_blocked+0x149e>
    ...
    2fd6:	89650513          	addi	a0,a0,-1898 # 6868 <filter_is_blocked+0x14ce>
    ...
    2fea:	89a50513          	addi	a0,a0,-1894 # 6880 <filter_is_blocked+0x14e6>
    ...
    2ffe:	8a650513          	addi	a0,a0,-1882 # 68a0 <filter_is_blocked+0x1506>
    ...
    3012:	8b250513          	addi	a0,a0,-1870 # 68c0 <filter_is_blocked+0x1526>
    ...
    3026:	8de50513          	addi	a0,a0,-1826 # 6900 <filter_is_blocked+0x1566>
    ...
    303a:	8fa50513          	addi	a0,a0,-1798 # 6930 <filter_is_blocked+0x1596>
    ...
    304e:	90650513          	addi	a0,a0,-1786 # 6950 <filter_is_blocked+0x15b6>
    ...
    3062:	91250513          	addi	a0,a0,-1774 # 6970 <filter_is_blocked+0x15d6>
    ...
    3076:	91e50513          	addi	a0,a0,-1762 # 6990 <filter_is_blocked+0x15f6>
    ...
    308a:	93a50513          	addi	a0,a0,-1734 # 69c0 <filter_is_blocked+0x1626>
    ...
    309e:	94e50513          	addi	a0,a0,-1714 # 69e8 <filter_is_blocked+0x164e>
    ...
    30b2:	96250513          	addi	a0,a0,-1694 # 6a10 <filter_is_blocked+0x1676>
    ...
    30c6:	97650513          	addi	a0,a0,-1674 # 6a38 <filter_is_blocked+0x169e>
    ...
    30da:	98250513          	addi	a0,a0,-1662 # 6a58 <filter_is_blocked+0x16be>
    ...
    30ee:	98e50513          	addi	a0,a0,-1650 # 6a78 <filter_is_blocked+0x16de>
    ...
    3102:	9a250513          	addi	a0,a0,-1630 # 6aa0 <filter_is_blocked+0x1706>
    ...
    3116:	9ae50513          	addi	a0,a0,-1618 # 6ac0 <filter_is_blocked+0x1726>
    ...
    312a:	9ba50513          	addi	a0,a0,-1606 # 6ae0 <filter_is_blocked+0x1746>
    ...
    313e:	9ce50513          	addi	a0,a0,-1586 # 6b08 <filter_is_blocked+0x176e>
    ...
    3152:	64a50513          	addi	a0,a0,1610 # 6798 <filter_is_blocked+0x13fe>
    ...
    3166:	9c650513          	addi	a0,a0,-1594 # 6b28 <filter_is_blocked+0x178e>
    ...
    317a:	9d250513          	addi	a0,a0,-1582 # 6b48 <filter_is_blocked+0x17ae>
    ...
    318e:	9ee50513          	addi	a0,a0,-1554 # 6b78 <filter_is_blocked+0x17de>
    ...
    31a2:	9fa50513          	addi	a0,a0,-1542 # 6b98 <filter_is_blocked+0x17fe>
...
00000000000031b0 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    323c:	98050513          	addi	a0,a0,-1664 # 6bb8 <filter_is_blocked+0x181e>
    ...
    3250:	98450513          	addi	a0,a0,-1660 # 6bd0 <filter_is_blocked+0x1836>
    ...
    3264:	98850513          	addi	a0,a0,-1656 # 6be8 <filter_is_blocked+0x184e>
    ...
    3278:	98c50513          	addi	a0,a0,-1652 # 6c00 <filter_is_blocked+0x1866>
    ...
    328c:	32850513          	addi	a0,a0,808 # 65b0 <filter_is_blocked+0x1216>
    ...
    32a0:	98450513          	addi	a0,a0,-1660 # 6c20 <filter_is_blocked+0x1886>
    ...
    32b4:	99850513          	addi	a0,a0,-1640 # 6c48 <filter_is_blocked+0x18ae>
    ...
    32c8:	9a450513          	addi	a0,a0,-1628 # 6c68 <filter_is_blocked+0x18ce>
...
00000000000032d6 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    32ec:	9a050513          	addi	a0,a0,-1632 # 6c88 <filter_is_blocked+0x18ee>
  ...
  if(chdir("dirfile") == 0){
    ...
    3300:	98c50513          	addi	a0,a0,-1652 # 6c88 <filter_is_blocked+0x18ee>
    3304:	2e1010ef          	jal	4de4 <chdir>
    3308:	c569                	beqz	a0,33d2 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    330a:	4581                	li	a1,0
    330c:	00004517          	auipc	a0,0x4
    3310:	9c450513          	addi	a0,a0,-1596 # 6cd0 <filter_is_blocked+0x1936>
  ...
  fd = open(".", 0);
    ...
    3390:	75450513          	addi	a0,a0,1876 # 5ae0 <filter_is_blocked+0x746>
    3394:	221010ef          	jal	4db4 <open>
    3398:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    339a:	4605                	li	a2,1
    339c:	00002597          	auipc	a1,0x2
    33a0:	0cc58593          	addi	a1,a1,204 # 5468 <filter_is_blocked+0xce>
  ...
  close(fd);
    ...
    33c4:	8d050513          	addi	a0,a0,-1840 # 6c90 <filter_is_blocked+0x18f6>
    ...
    33d8:	8dc50513          	addi	a0,a0,-1828 # 6cb0 <filter_is_blocked+0x1916>
    ...
    33ec:	8f850513          	addi	a0,a0,-1800 # 6ce0 <filter_is_blocked+0x1946>
    ...
    3400:	8e450513          	addi	a0,a0,-1820 # 6ce0 <filter_is_blocked+0x1946>
    ...
    3414:	8f850513          	addi	a0,a0,-1800 # 6d08 <filter_is_blocked+0x196e>
    ...
    3428:	90c50513          	addi	a0,a0,-1780 # 6d30 <filter_is_blocked+0x1996>
    ...
    343c:	92050513          	addi	a0,a0,-1760 # 6d58 <filter_is_blocked+0x19be>
    ...
    3450:	93450513          	addi	a0,a0,-1740 # 6d80 <filter_is_blocked+0x19e6>
    ...
    3464:	94050513          	addi	a0,a0,-1728 # 6da0 <filter_is_blocked+0x1a06>
    ...
    3478:	95450513          	addi	a0,a0,-1708 # 6dc8 <filter_is_blocked+0x1a2e>
...
0000000000003486 <iref>:
{
    ...
    34a4:	940a0a13          	addi	s4,s4,-1728 # 6de0 <filter_is_blocked+0x1a46>
    mkdir("");
    34a8:	00003497          	auipc	s1,0x3
    34ac:	44048493          	addi	s1,s1,1088 # 68e8 <filter_is_blocked+0x154e>
    link("README", "");
    34b0:	00002a97          	auipc	s5,0x2
    34b4:	120a8a93          	addi	s5,s5,288 # 55d0 <filter_is_blocked+0x236>
    fd = open("xx", O_CREATE);
    34b8:	00004997          	auipc	s3,0x4
    34bc:	82098993          	addi	s3,s3,-2016 # 6cd8 <filter_is_blocked+0x193e>
    34c0:	a835                	j	34fc <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34c2:	85da                	mv	a1,s6
    34c4:	00004517          	auipc	a0,0x4
    34c8:	92450513          	addi	a0,a0,-1756 # 6de8 <filter_is_blocked+0x1a4e>
    ...
    34dc:	92850513          	addi	a0,a0,-1752 # 6e00 <filter_is_blocked+0x1a66>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3544:	0c098993          	addi	s3,s3,192 # 6600 <filter_is_blocked+0x1266>
    unlink("irefd");
    3548:	00004917          	auipc	s2,0x4
    354c:	89890913          	addi	s2,s2,-1896 # 6de0 <filter_is_blocked+0x1a46>
    chdir("..");
    3550:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3564:	04850513          	addi	a0,a0,72 # 65a8 <filter_is_blocked+0x120e>
...
0000000000003580 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3590:	88c50513          	addi	a0,a0,-1908 # 6e18 <filter_is_blocked+0x1a7e>
  ...
  if(pid == 0){
    ...
    35ac:	87050513          	addi	a0,a0,-1936 # 6e18 <filter_is_blocked+0x1a7e>
    ...
    35be:	87e50513          	addi	a0,a0,-1922 # 6e38 <filter_is_blocked+0x1a9e>
    ...
    35d2:	85250513          	addi	a0,a0,-1966 # 6e20 <filter_is_blocked+0x1a86>
    ...
    35e6:	6a650513          	addi	a0,a0,1702 # 5c88 <filter_is_blocked+0x8ee>
  ...
  if(unlink("oidir") != 0){
    ...
    3604:	81850513          	addi	a0,a0,-2024 # 6e18 <filter_is_blocked+0x1a7e>
    3608:	7bc010ef          	jal	4dc4 <unlink>
    360c:	c919                	beqz	a0,3622 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    360e:	85a6                	mv	a1,s1
    3610:	00003517          	auipc	a0,0x3
    3614:	86850513          	addi	a0,a0,-1944 # 5e78 <filter_is_blocked+0xade>
...
0000000000003632 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3642:	82250513          	addi	a0,a0,-2014 # 6e60 <filter_is_blocked+0x1ac6>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3662:	80250513          	addi	a0,a0,-2046 # 6e60 <filter_is_blocked+0x1ac6>
  ...
  pause(10); // one second
    ...
    368a:	7c250513          	addi	a0,a0,1986 # 5e48 <filter_is_blocked+0xaae>
    ...
    369c:	7c848493          	addi	s1,s1,1992 # 6e60 <filter_is_blocked+0x1ac6>
    36a0:	4581                	li	a1,0
    36a2:	8526                	mv	a0,s1
    ...
    36bc:	7a850513          	addi	a0,a0,1960 # 6e60 <filter_is_blocked+0x1ac6>
...
00000000000036d0 <killstatus>:
{
  ...
  exit(0);
    ...
    3722:	56a50513          	addi	a0,a0,1386 # 5c88 <filter_is_blocked+0x8ee>
    ...
    373c:	73850513          	addi	a0,a0,1848 # 6e70 <filter_is_blocked+0x1ad6>
...
000000000000374a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3770:	6dc50513          	addi	a0,a0,1756 # 5e48 <filter_is_blocked+0xaae>
  ...
  if(pid2 == 0)
    ...
    3792:	4fa50513          	addi	a0,a0,1274 # 5c88 <filter_is_blocked+0x8ee>
  ...
  if(pid3 == 0){
    ...
    37c2:	caa58593          	addi	a1,a1,-854 # 5468 <filter_is_blocked+0xce>
    ...
    37e4:	4a850513          	addi	a0,a0,1192 # 5c88 <filter_is_blocked+0x8ee>
    ...
    37f8:	69c50513          	addi	a0,a0,1692 # 6e90 <filter_is_blocked+0x1af6>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3828:	68450513          	addi	a0,a0,1668 # 6ea8 <filter_is_blocked+0x1b0e>
  ...
  printf("kill... ");
    ...
    384c:	67850513          	addi	a0,a0,1656 # 6ec0 <filter_is_blocked+0x1b26>
  ...
  printf("wait... ");
    ...
    386a:	66a50513          	addi	a0,a0,1642 # 6ed0 <filter_is_blocked+0x1b36>
...
0000000000003886 <reparent>:
{
  ...
  exit(0);
    ...
    38ca:	3c250513          	addi	a0,a0,962 # 5c88 <filter_is_blocked+0x8ee>
    ...
    38de:	53650513          	addi	a0,a0,1334 # 5e10 <filter_is_blocked+0xa76>
...
0000000000003906 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3942:	45250513          	addi	a0,a0,1106 # 5d90 <filter_is_blocked+0x9f6>
    ...
    396c:	cf058593          	addi	a1,a1,-784 # 7658 <filter_is_blocked+0x22be>
    ...
    3988:	55c58593          	addi	a1,a1,1372 # 6ee0 <filter_is_blocked+0x1b46>
  ...
  c = sbrk(PGSIZE);
    ...
    39da:	51250513          	addi	a0,a0,1298 # 6ee8 <filter_is_blocked+0x1b4e>
  ...
  if(pid == 0){
    ...
    3a24:	51850513          	addi	a0,a0,1304 # 6f38 <filter_is_blocked+0x1b9e>
    ...
    3a38:	4e450513          	addi	a0,a0,1252 # 6f18 <filter_is_blocked+0x1b7e>
    ...
    3a4c:	24050513          	addi	a0,a0,576 # 5c88 <filter_is_blocked+0x8ee>
...
0000000000003a8a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3aee:	47e50513          	addi	a0,a0,1150 # 6f68 <filter_is_blocked+0x1bce>
...
0000000000003b02 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b12:	47a50513          	addi	a0,a0,1146 # 6f88 <filter_is_blocked+0x1bee>
    3b16:	2ae010ef          	jal	4dc4 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b1a:	20200593          	li	a1,514
    3b1e:	00003517          	auipc	a0,0x3
    3b22:	46a50513          	addi	a0,a0,1130 # 6f88 <filter_is_blocked+0x1bee>
  ...
  if(pid == 0) {
    ...
    3b8c:	41050513          	addi	a0,a0,1040 # 6f98 <filter_is_blocked+0x1bfe>
    ...
    3ba0:	42450513          	addi	a0,a0,1060 # 6fc0 <filter_is_blocked+0x1c26>
  ...
  fd = open("sharedfd", 0);
    ...
    3bd0:	3bc50513          	addi	a0,a0,956 # 6f88 <filter_is_blocked+0x1bee>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3c08:	3dc50513          	addi	a0,a0,988 # 6fe0 <filter_is_blocked+0x1c46>
  ...
  unlink("sharedfd");
    ...
    3c38:	35450513          	addi	a0,a0,852 # 6f88 <filter_is_blocked+0x1bee>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3c5a:	3b250513          	addi	a0,a0,946 # 7008 <filter_is_blocked+0x1c6e>
...
0000000000003c6e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c92:	39278793          	addi	a5,a5,914 # 7020 <filter_is_blocked+0x1c86>
    3c96:	f6f43823          	sd	a5,-144(s0)
    3c9a:	00003797          	auipc	a5,0x3
    3c9e:	38e78793          	addi	a5,a5,910 # 7028 <filter_is_blocked+0x1c8e>
    3ca2:	f6f43c23          	sd	a5,-136(s0)
    3ca6:	00003797          	auipc	a5,0x3
    3caa:	38a78793          	addi	a5,a5,906 # 7030 <filter_is_blocked+0x1c96>
    3cae:	f8f43023          	sd	a5,-128(s0)
    3cb2:	00003797          	auipc	a5,0x3
    3cb6:	38678793          	addi	a5,a5,902 # 7038 <filter_is_blocked+0x1c9e>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d18:	f7450513          	addi	a0,a0,-140 # 5c88 <filter_is_blocked+0x8ee>
    ...
    3d7a:	faa50513          	addi	a0,a0,-86 # 5d20 <filter_is_blocked+0x986>
    ...
    3d8c:	2b850513          	addi	a0,a0,696 # 7040 <filter_is_blocked+0x1ca6>
    ...
    3da6:	2b650513          	addi	a0,a0,694 # 7058 <filter_is_blocked+0x1cbe>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e16:	25650513          	addi	a0,a0,598 # 7068 <filter_is_blocked+0x1cce>
...
0000000000003e42 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e70:	214b8b93          	addi	s7,s7,532 # 7080 <filter_is_blocked+0x1ce6>
  for(i = 0; i < N; i++){
    ...
    3eaa:	1e250513          	addi	a0,a0,482 # 7088 <filter_is_blocked+0x1cee>
    ...
    3ec0:	1c450513          	addi	a0,a0,452 # 7080 <filter_is_blocked+0x1ce6>
  ...
  fd = open(".", 0);
    ...
    3ee8:	bfc50513          	addi	a0,a0,-1028 # 5ae0 <filter_is_blocked+0x746>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f58:	15450513          	addi	a0,a0,340 # 70a8 <filter_is_blocked+0x1d0e>
    ...
    3f70:	15c50513          	addi	a0,a0,348 # 70c8 <filter_is_blocked+0x1d2e>
  ...
  for(i = 0; i < N; i++){
    ...
    3f9c:	15850513          	addi	a0,a0,344 # 70f0 <filter_is_blocked+0x1d56>
    ...
    3fb0:	cdc50513          	addi	a0,a0,-804 # 5c88 <filter_is_blocked+0x8ee>
...
00000000000040e6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40fe:	02e50513          	addi	a0,a0,46 # 7128 <filter_is_blocked+0x1d8e>
    4102:	4c3000ef          	jal	4dc4 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    4106:	20200593          	li	a1,514
    410a:	00003517          	auipc	a0,0x3
    410e:	01e50513          	addi	a0,a0,30 # 7128 <filter_is_blocked+0x1d8e>
  ...
  fd = open("bigfile.dat", 0);
    ...
    415a:	fd250513          	addi	a0,a0,-46 # 7128 <filter_is_blocked+0x1d8e>
  ...
  for(i = 0; ; i++){
    ...
    41b6:	f8650513          	addi	a0,a0,-122 # 7138 <filter_is_blocked+0x1d9e>
    ...
    41ca:	f9250513          	addi	a0,a0,-110 # 7158 <filter_is_blocked+0x1dbe>
    ...
    41de:	f9e50513          	addi	a0,a0,-98 # 7178 <filter_is_blocked+0x1dde>
    ...
    41f2:	faa50513          	addi	a0,a0,-86 # 7198 <filter_is_blocked+0x1dfe>
    ...
    4206:	fb650513          	addi	a0,a0,-74 # 71b8 <filter_is_blocked+0x1e1e>
    ...
    421a:	fba50513          	addi	a0,a0,-70 # 71d0 <filter_is_blocked+0x1e36>
  ...
  unlink("bigfile.dat");
    ...
    423c:	ef050513          	addi	a0,a0,-272 # 7128 <filter_is_blocked+0x1d8e>
    ...
    425c:	f9850513          	addi	a0,a0,-104 # 71f0 <filter_is_blocked+0x1e56>
...
000000000000426a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    427a:	f9a50513          	addi	a0,a0,-102 # 7210 <filter_is_blocked+0x1e76>
  ...
  fd = open("bigarg-ok", 0);
    ...
    42a0:	f7450513          	addi	a0,a0,-140 # 7210 <filter_is_blocked+0x1e76>
  ...
  close(fd);
    ...
    42fa:	10250513          	addi	a0,a0,258 # 53f8 <filter_is_blocked+0x5e>
    42fe:	2af000ef          	jal	4dac <exec>
    fd = open("bigarg-ok", O_CREATE);
    4302:	20000593          	li	a1,512
    4306:	00003517          	auipc	a0,0x3
    430a:	f0a50513          	addi	a0,a0,-246 # 7210 <filter_is_blocked+0x1e76>
    ...
    4322:	f0250513          	addi	a0,a0,-254 # 7220 <filter_is_blocked+0x1e86>
    ...
    433a:	f0a50513          	addi	a0,a0,-246 # 7240 <filter_is_blocked+0x1ea6>
...
0000000000004348 <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4392:	ed250513          	addi	a0,a0,-302 # 7260 <filter_is_blocked+0x1ec6>
    ...
    43a4:	ed850513          	addi	a0,a0,-296 # 7278 <filter_is_blocked+0x1ede>
...
00000000000043b2 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    441a:	e4a50513          	addi	a0,a0,-438 # 7260 <filter_is_blocked+0x1ec6>
    ...
    442c:	e7850513          	addi	a0,a0,-392 # 72a0 <filter_is_blocked+0x1f06>
    ...
    4450:	e6450513          	addi	a0,a0,-412 # 72b0 <filter_is_blocked+0x1f16>
...
000000000000445e <lazy_copy>:
{
    ...
    44a6:	e2650513          	addi	a0,a0,-474 # 72c8 <filter_is_blocked+0x1f2e>
  ...
  unsigned long bad[] = {
    ...
    44b8:	48c78793          	addi	a5,a5,1164 # 7940 <filter_is_blocked+0x25a6>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    44ec:	0e8a0a13          	addi	s4,s4,232 # 55d0 <filter_is_blocked+0x236>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    44f0:	00001a97          	auipc	s5,0x1
    44f4:	ff0a8a93          	addi	s5,s5,-16 # 54e0 <filter_is_blocked+0x146>
    int fd = open("README", 0);
    44f8:	4581                	li	a1,0
    44fa:	8552                	mv	a0,s4
...
0000000000004596 <lazy_sbrk>:
{
  ...
  if (p1 < 0 || p1 != p) {
    ...
    45e4:	d7050513          	addi	a0,a0,-656 # 7350 <filter_is_blocked+0x1fb6>
  ...
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    460c:	d7850513          	addi	a0,a0,-648 # 7380 <filter_is_blocked+0x1fe6>
  ...
  if (p[1] != 0) {
    ...
    4632:	d8a50513          	addi	a0,a0,-630 # 73b8 <filter_is_blocked+0x201e>
  ...
  if ((uint64)p != -1) {
    ...
    4652:	d9250513          	addi	a0,a0,-622 # 73e0 <filter_is_blocked+0x2046>
  ...
  if ((uint64)p != -1) {
    ...
    4672:	d9a50513          	addi	a0,a0,-614 # 7408 <filter_is_blocked+0x206e>
...
0000000000004686 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    46a6:	d9650513          	addi	a0,a0,-618 # 7438 <filter_is_blocked+0x209e>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    46c2:	d8ac8c93          	addi	s9,s9,-630 # 7448 <filter_is_blocked+0x20ae>
    name[0] = 'f';
    ...
    472a:	d3250513          	addi	a0,a0,-718 # 7458 <filter_is_blocked+0x20be>
  ...
  printf("fsfull test finished\n");
    ...
    4798:	ce450513          	addi	a0,a0,-796 # 7478 <filter_is_blocked+0x20de>
    ...
    47e6:	c8650513          	addi	a0,a0,-890 # 7468 <filter_is_blocked+0x20ce>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4810:	c8450513          	addi	a0,a0,-892 # 7490 <filter_is_blocked+0x20f6>
  ...
  if(pid == 0) {
    ...
    4834:	c8850513          	addi	a0,a0,-888 # 74b8 <filter_is_blocked+0x211e>
    ...
    4854:	c5050513          	addi	a0,a0,-944 # 74a0 <filter_is_blocked+0x2106>
    ...
    4870:	c5450513          	addi	a0,a0,-940 # 74c0 <filter_is_blocked+0x2126>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    48c2:	c0a50513          	addi	a0,a0,-1014 # 74c8 <filter_is_blocked+0x212e>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    495a:	b8ac0c13          	addi	s8,s8,-1142 # 74e0 <filter_is_blocked+0x2146>
    int free0 = countfree();
    int free1 = 0;
    int ntests = 0;
    int n;
    ...
    4974:	b88d8d93          	addi	s11,s11,-1144 # 74f8 <filter_is_blocked+0x215e>
      } else {
        ntests += n;
      }
    }
    ...
    497c:	ba0d0d13          	addi	s10,s10,-1120 # 7518 <filter_is_blocked+0x217e>
    ...
    49f6:	b5650513          	addi	a0,a0,-1194 # 7548 <filter_is_blocked+0x21ae>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4a60:	b0458593          	addi	a1,a1,-1276 # 7560 <filter_is_blocked+0x21c6>
  ...
  char *justone = 0;
    ...
    4a7a:	af258593          	addi	a1,a1,-1294 # 7568 <filter_is_blocked+0x21ce>
    4a7e:	00893503          	ld	a0,8(s2)
    4a82:	08a000ef          	jal	4b0c <strcmp>
    4a86:	cd15                	beqz	a0,4ac2 <main+0x94>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    4a88:	00003597          	auipc	a1,0x3
    4a8c:	b3058593          	addi	a1,a1,-1232 # 75b8 <filter_is_blocked+0x221e>
  ...
  int continuous = 0;
    ...
    4ab4:	ac050513          	addi	a0,a0,-1344 # 7570 <filter_is_blocked+0x21d6>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4ad2:	ad250513          	addi	a0,a0,-1326 # 75a0 <filter_is_blocked+0x2206>
...
printint(int fd, long long xx, int base, int sgn)
{
  ...
  do{
    ...
    4e68:	b8450513          	addi	a0,a0,-1148 # 79e8 <digits>
    4e6c:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    50fe:	8eeb8b93          	addi	s7,s7,-1810 # 79e8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5160:	7dc90913          	addi	s2,s2,2012 # 7938 <filter_is_blocked+0x259e>
        for(; *s; s++)
...
0000000000005360 <filter_enable>:
...
int filter_enable(long blacklist_mask) {
    ...
    5368:	aadff0ef          	jal	4e14 <setfilter>
}
    536c:	60a2                	ld	ra,8(sp)
    536e:	6402                	ld	s0,0(sp)
    5370:	0141                	addi	sp,sp,16
    5372:	8082                	ret

0000000000005374 <filter_add_rule>:

int filter_add_rule(int sys_num) {
    5374:	1101                	addi	sp,sp,-32
    5376:	ec06                	sd	ra,24(sp)
    5378:	e822                	sd	s0,16(sp)
    537a:	e426                	sd	s1,8(sp)
    537c:	1000                	addi	s0,sp,32
    537e:	84aa                	mv	s1,a0
    long current_mask = getfilter();
    5380:	a9dff0ef          	jal	4e1c <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
    5384:	4785                	li	a5,1
    5386:	009797b3          	sll	a5,a5,s1
    538a:	8d5d                	or	a0,a0,a5
    538c:	a89ff0ef          	jal	4e14 <setfilter>
}
    5390:	60e2                	ld	ra,24(sp)
    5392:	6442                	ld	s0,16(sp)
    5394:	64a2                	ld	s1,8(sp)
    5396:	6105                	addi	sp,sp,32
    5398:	8082                	ret

000000000000539a <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
    ...
    53a2:	1000                	addi	s0,sp,32
    53a4:	84aa                	mv	s1,a0
    long current_mask = getfilter();
    53a6:	a77ff0ef          	jal	4e1c <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
    53aa:	40955533          	sra	a0,a0,s1
}
    53ae:	8905                	andi	a0,a0,1
    53b0:	60e2                	ld	ra,24(sp)
    53b2:	6442                	ld	s0,16(sp)
    53b4:	64a2                	ld	s1,8(sp)
    53b6:	6105                	addi	sp,sp,32
    53b8:	8082                	ret
