...
main(void)
{
  ...
  12:	99250513          	addi	a0,a0,-1646 # 9a0 <filter_is_blocked+0x2a>
  ...
  2e:	97e90913          	addi	s2,s2,-1666 # 9a8 <filter_is_blocked+0x32>
  32:	854a                	mv	a0,s2
  ...
  56:	9a650513          	addi	a0,a0,-1626 # 9f8 <filter_is_blocked+0x82>
  ...
  6c:	93850513          	addi	a0,a0,-1736 # 9a0 <filter_is_blocked+0x2a>
  70:	328000ef          	jal	398 <mknod>
    open("console", O_RDWR);
  74:	4589                	li	a1,2
  76:	00001517          	auipc	a0,0x1
  7a:	92a50513          	addi	a0,a0,-1750 # 9a0 <filter_is_blocked+0x2a>
  7e:	312000ef          	jal	390 <open>
  82:	bf71                	j	1e <main+0x1e>
      printf("init: fork failed\n");
  84:	00001517          	auipc	a0,0x1
  88:	93c50513          	addi	a0,a0,-1732 # 9c0 <filter_is_blocked+0x4a>
  ...
  a2:	93a50513          	addi	a0,a0,-1734 # 9d8 <filter_is_blocked+0x62>
  a6:	2e2000ef          	jal	388 <exec>
      printf("init: exec sh failed\n");
  aa:	00001517          	auipc	a0,0x1
  ae:	93650513          	addi	a0,a0,-1738 # 9e0 <filter_is_blocked+0x6a>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 444:	5e050513          	addi	a0,a0,1504 # a20 <digits>
 448:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6da:	34ab8b93          	addi	s7,s7,842 # a20 <digits>
 ...
 73c:	2e090913          	addi	s2,s2,736 # a18 <filter_is_blocked+0xa2>
        for(; *s; s++)
...
000000000000093c <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 944:	aadff0ef          	jal	3f0 <setfilter>
}
 948:	60a2                	ld	ra,8(sp)
 94a:	6402                	ld	s0,0(sp)
...
0000000000000950 <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 95c:	a9dff0ef          	jal	3f8 <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 960:	4785                	li	a5,1
 962:	009797b3          	sll	a5,a5,s1
 966:	8d5d                	or	a0,a0,a5
 968:	a89ff0ef          	jal	3f0 <setfilter>
}
...
0000000000000976 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 980:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 982:	a77ff0ef          	jal	3f8 <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 986:	40955533          	sra	a0,a0,s1
}
 98a:	8905                	andi	a0,a0,1
