...
wc(int fd, char *name)
{
  ...
  3c:	a08a0a13          	addi	s4,s4,-1528 # a40 <filter_is_blocked+0x2a>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  a2:	9c250513          	addi	a0,a0,-1598 # a60 <filter_is_blocked+0x4a>
  ...
  cc:	98850513          	addi	a0,a0,-1656 # a50 <filter_is_blocked+0x3a>
...
main(int argc, char *argv[])
{
 ...
 136:	91658593          	addi	a1,a1,-1770 # a48 <filter_is_blocked+0x32>
 13a:	4501                	li	a0,0
 ...
 14e:	92650513          	addi	a0,a0,-1754 # a70 <filter_is_blocked+0x5a>
...
00000000000004a0 <setfilter_child>:
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 4e4:	5b050513          	addi	a0,a0,1456 # a90 <digits>
 4e8:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 77a:	31ab8b93          	addi	s7,s7,794 # a90 <digits>
 ...
 7dc:	2b090913          	addi	s2,s2,688 # a88 <filter_is_blocked+0x72>
        for(; *s; s++)
...
00000000000009dc <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 9e4:	aadff0ef          	jal	490 <setfilter>
}
 9e8:	60a2                	ld	ra,8(sp)
 9ea:	6402                	ld	s0,0(sp)
...
00000000000009f0 <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 9fc:	a9dff0ef          	jal	498 <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 a00:	4785                	li	a5,1
 a02:	009797b3          	sll	a5,a5,s1
 a06:	8d5d                	or	a0,a0,a5
 a08:	a89ff0ef          	jal	490 <setfilter>
}
...
0000000000000a16 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 a20:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 a22:	a77ff0ef          	jal	498 <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 a26:	40955533          	sra	a0,a0,s1
}
 a2a:	8905                	andi	a0,a0,1
