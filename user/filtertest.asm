...
static void result(const char *name, int ok) {
  ...
  10:	b1450513          	addi	a0,a0,-1260 # b20 <filter_is_blocked+0x28>
  ...
  26:	b0e50513          	addi	a0,a0,-1266 # b30 <filter_is_blocked+0x38>
...
void test1_initial_mask_zero(void) {
  ...
  54:	af050513          	addi	a0,a0,-1296 # b40 <filter_is_blocked+0x48>
...
void test2_set_get_mask(void) {
  ...
  94:	ac850513          	addi	a0,a0,-1336 # b58 <filter_is_blocked+0x60>
...
void test3_fork_inheritance(void) {
 ...
 10a:	a7250513          	addi	a0,a0,-1422 # b78 <filter_is_blocked+0x80>
...
void test4_policy_weaken(void) {
 ...
 13e:	a5650513          	addi	a0,a0,-1450 # b90 <filter_is_blocked+0x98>
...
void test5_policy_tighten(void) {
 ...
 188:	a2c50513          	addi	a0,a0,-1492 # bb0 <filter_is_blocked+0xb8>
...
void test6_write_blocked(void) {
 ...
 1d0:	a1450513          	addi	a0,a0,-1516 # be0 <filter_is_blocked+0xe8>
 ...
 1ec:	9e858593          	addi	a1,a1,-1560 # bd0 <filter_is_blocked+0xd8>
 1f0:	4505                	li	a0,1
...
int main(void) {
 ...
 20c:	a0050513          	addi	a0,a0,-1536 # c08 <filter_is_blocked+0x110>
 ...
 230:	a0c50513          	addi	a0,a0,-1524 # c38 <filter_is_blocked+0x140>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 5c6:	6ae50513          	addi	a0,a0,1710 # c70 <digits>
 5ca:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 85c:	418b8b93          	addi	s7,s7,1048 # c70 <digits>
 ...
 8be:	3ae90913          	addi	s2,s2,942 # c68 <filter_is_blocked+0x170>
        for(; *s; s++)
...
0000000000000abe <filter_enable>:
#include "kernel/types.h"
#include "user/user.h"
#include "user/filter.h"
...
int filter_enable(long blacklist_mask) {
 ...
 ac6:	aadff0ef          	jal	572 <setfilter>
}
 aca:	60a2                	ld	ra,8(sp)
 acc:	6402                	ld	s0,0(sp)
...
0000000000000ad2 <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 ade:	a9dff0ef          	jal	57a <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 ae2:	4785                	li	a5,1
 ae4:	009797b3          	sll	a5,a5,s1
 ae8:	8d5d                	or	a0,a0,a5
 aea:	a89ff0ef          	jal	572 <setfilter>
}
...
0000000000000af8 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 b02:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 b04:	a77ff0ef          	jal	57a <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 b08:	40955533          	sra	a0,a0,s1
}
 b0c:	8905                	andi	a0,a0,1
