...
static void result(const char *name, int ok) {
  ...
  10:	bc450513          	addi	a0,a0,-1084 # bd0 <filter_debug_status+0x96>
  ...
  26:	bbe50513          	addi	a0,a0,-1090 # be0 <filter_debug_status+0xa6>
...
void test1_initial_mask_zero(void) {
  ...
  54:	ba050513          	addi	a0,a0,-1120 # bf0 <filter_debug_status+0xb6>
...
void test2_set_get_mask(void) {
  ...
  94:	b7850513          	addi	a0,a0,-1160 # c08 <filter_debug_status+0xce>
...
void test3_fork_inheritance(void) {
 ...
 10a:	b2250513          	addi	a0,a0,-1246 # c28 <filter_debug_status+0xee>
...
void test4_policy_weaken(void) {
 ...
 13e:	b0650513          	addi	a0,a0,-1274 # c40 <filter_debug_status+0x106>
 ...
 156:	41c000ef          	jal	572 <setfilter>
    exit(r == -1 ? 1 : 0);
 15a:	0505                	addi	a0,a0,1 # 4001 <base+0x1ff1>
...
void test5_policy_tighten(void) {
 ...
 188:	adc50513          	addi	a0,a0,-1316 # c60 <filter_debug_status+0x126>
...
void test6_write_blocked(void) {
 ...
 1d0:	ac450513          	addi	a0,a0,-1340 # c90 <filter_debug_status+0x156>
 ...
 1ec:	a9858593          	addi	a1,a1,-1384 # c80 <filter_debug_status+0x146>
 1f0:	4505                	li	a0,1
 1f2:	300000ef          	jal	4f2 <write>
    exit(r == -1 ? 1 : 0);
 1f6:	0505                	addi	a0,a0,1 # 10001 <base+0xdff1>
...
int main(void) {
 ...
 20c:	ab050513          	addi	a0,a0,-1360 # cb8 <filter_debug_status+0x17e>
 ...
 230:	abc50513          	addi	a0,a0,-1348 # ce8 <filter_debug_status+0x1ae>
...
strcpy(char *s, const char *t)
{
 ...
 258:	0785                	addi	a5,a5,1 # ffffffffffffc001 <base+0xffffffffffff9ff1>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 5c6:	82650513          	addi	a0,a0,-2010 # de8 <digits>
 5ca:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 85c:	590b8b93          	addi	s7,s7,1424 # de8 <digits>
 ...
 8be:	45e90913          	addi	s2,s2,1118 # d18 <filter_debug_status+0x1de>
        for(; *s; s++)
...
free(void *ap)
{
 ...
 952:	6b27b783          	ld	a5,1714(a5) # 2000 <freep>
...
malloc(uint nbytes)
{
 ...
 9e6:	61e53503          	ld	a0,1566(a0) # 2000 <freep>
 ...
 a0e:	004a1a1b          	slliw	s4,s4,0x4
    ...
    if(p == freep)
 a12:	00001917          	auipc	s2,0x1
 a16:	5ee90913          	addi	s2,s2,1518 # 2000 <freep>
  if(p == SBRK_ERROR)
 a1a:	5afd                	li	s5,-1
 ...
 a2a:	5ea78793          	addi	a5,a5,1514 # 2010 <base>
 ...
 aa0:	56a73223          	sd	a0,1380(a4) # 2000 <freep>
      return (void*)(p + 1);
...
int filter_apply(long blacklist_mask) {
 ...
 ac6:	fff54513          	not	a0,a0
 aca:	aa9ff0ef          	jal	572 <setfilter>
}
 ace:	60a2                	ld	ra,8(sp)
 ad0:	6402                	ld	s0,0(sp)
...
0000000000000ad6 <filter_block_syscall>:

int filter_block_syscall(int sys_num) {
 ad6:	1101                	addi	sp,sp,-32
...
int filter_reset(void) {
 ...
 b08:	557d                	li	a0,-1
 b0a:	a69ff0ef          	jal	572 <setfilter>
}
 b0e:	60a2                	ld	ra,8(sp)
 b10:	6402                	ld	s0,0(sp)
...
0000000000000b16 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 b20:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 b22:	a59ff0ef          	jal	57a <getfilter>
    return !(current_mask & BLOCK(sys_num));
 b26:	40955533          	sra	a0,a0,s1
 b2a:	00154513          	xori	a0,a0,1
}
 b2e:	8905                	andi	a0,a0,1
...
0000000000000b3a <filter_debug_status>:
...
void filter_debug_status(void) {
 ...
 b42:	1000                	addi	s0,sp,32
    long m = getfilter();
 b44:	a37ff0ef          	jal	57a <getfilter>
 b48:	84aa                	mv	s1,a0
    printf("\n[Sandbox Monitor]\n");
 b4a:	00000517          	auipc	a0,0x0
 b4e:	20650513          	addi	a0,a0,518 # d50 <filter_debug_status+0x216>
 b52:	dc1ff0ef          	jal	912 <printf>
    printf("Whitelist Mask: %ld\n", m);
 b56:	85a6                	mv	a1,s1
 b58:	00000517          	auipc	a0,0x0
 b5c:	21050513          	addi	a0,a0,528 # d68 <filter_debug_status+0x22e>
 b60:	db3ff0ef          	jal	912 <printf>
    printf("Security Level: %s\n", (m == 0xFFFFFFFFFFFFFFFFL) ? "LOW (Permissive)" : "HIGH (Restricted)");
 b64:	57fd                	li	a5,-1
 b66:	00000597          	auipc	a1,0x0
 b6a:	1d258593          	addi	a1,a1,466 # d38 <filter_debug_status+0x1fe>
 b6e:	02f48b63          	beq	s1,a5,ba4 <filter_debug_status+0x6a>
 b72:	00000517          	auipc	a0,0x0
 b76:	20e50513          	addi	a0,a0,526 # d80 <filter_debug_status+0x246>
 b7a:	d99ff0ef          	jal	912 <printf>
    
    if(filter_is_blocked(SYS_open)) printf(" - File access: LOCKED\n");
 b7e:	453d                	li	a0,15
 b80:	f97ff0ef          	jal	b16 <filter_is_blocked>
 b84:	e50d                	bnez	a0,bae <filter_debug_status+0x74>
    if(filter_is_blocked(SYS_fork)) printf(" - Process creation: LOCKED\n");
 b86:	4505                	li	a0,1
 b88:	f8fff0ef          	jal	b16 <filter_is_blocked>
 b8c:	e905                	bnez	a0,bbc <filter_debug_status+0x82>
    printf("------------------\n");
 b8e:	00000517          	auipc	a0,0x0
 b92:	24250513          	addi	a0,a0,578 # dd0 <filter_debug_status+0x296>
 b96:	d7dff0ef          	jal	912 <printf>
 b9a:	60e2                	ld	ra,24(sp)
 b9c:	6442                	ld	s0,16(sp)
 b9e:	64a2                	ld	s1,8(sp)
 ba0:	6105                	addi	sp,sp,32
 ba2:	8082                	ret
    printf("Security Level: %s\n", (m == 0xFFFFFFFFFFFFFFFFL) ? "LOW (Permissive)" : "HIGH (Restricted)");
 ba4:	00000597          	auipc	a1,0x0
 ba8:	17c58593          	addi	a1,a1,380 # d20 <filter_debug_status+0x1e6>
 bac:	b7d9                	j	b72 <filter_debug_status+0x38>
    if(filter_is_blocked(SYS_open)) printf(" - File access: LOCKED\n");
 bae:	00000517          	auipc	a0,0x0
 bb2:	1ea50513          	addi	a0,a0,490 # d98 <filter_debug_status+0x25e>
 bb6:	d5dff0ef          	jal	912 <printf>
 bba:	b7f1                	j	b86 <filter_debug_status+0x4c>
    if(filter_is_blocked(SYS_fork)) printf(" - Process creation: LOCKED\n");
 bbc:	00000517          	auipc	a0,0x0
 bc0:	1f450513          	addi	a0,a0,500 # db0 <filter_debug_status+0x276>
 bc4:	d4fff0ef          	jal	912 <printf>
 bc8:	b7d9                	j	b8e <filter_debug_status+0x54>
