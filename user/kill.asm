...
main(int argc, char **argv)
{
  ...
  44:	8f058593          	addi	a1,a1,-1808 # 930 <filter_is_blocked+0x22>
  48:	4509                	li	a0,2
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3dc:	57850513          	addi	a0,a0,1400 # 950 <digits>
 3e0:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 672:	2e2b8b93          	addi	s7,s7,738 # 950 <digits>
 ...
 6d4:	27890913          	addi	s2,s2,632 # 948 <filter_is_blocked+0x3a>
        for(; *s; s++)
...
00000000000008d4 <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 8dc:	aadff0ef          	jal	388 <setfilter>
}
 8e0:	60a2                	ld	ra,8(sp)
 8e2:	6402                	ld	s0,0(sp)
...
00000000000008e8 <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 8f4:	a9dff0ef          	jal	390 <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 8f8:	4785                	li	a5,1
 8fa:	009797b3          	sll	a5,a5,s1
 8fe:	8d5d                	or	a0,a0,a5
 900:	a89ff0ef          	jal	388 <setfilter>
}
...
000000000000090e <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 918:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 91a:	a77ff0ef          	jal	390 <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 91e:	40955533          	sra	a0,a0,s1
}
 922:	8905                	andi	a0,a0,1
 924:	60e2                	ld	ra,24(sp)
 926:	6442                	ld	s0,16(sp)
 928:	64a2                	ld	s1,8(sp)
 92a:	6105                	addi	sp,sp,32
 92c:	8082                	ret
