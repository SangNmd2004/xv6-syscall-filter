...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	26e58593          	addi	a1,a1,622 # 1280 <filter_is_blocked+0x2c>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	23c58593          	addi	a1,a1,572 # 1290 <filter_is_blocked+0x3c>
      5c:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	21650513          	addi	a0,a0,534 # 1298 <filter_is_blocked+0x44>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ae:	2ee70713          	addi	a4,a4,750 # 1398 <filter_is_blocked+0x144>
    ...
    panic("runcmd");
      ...
      c6:	1de50513          	addi	a0,a0,478 # 12a0 <filter_is_blocked+0x4c>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e0:	1cc58593          	addi	a1,a1,460 # 12a8 <filter_is_blocked+0x54>
      e4:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     114:	1a858593          	addi	a1,a1,424 # 12b8 <filter_is_blocked+0x64>
     118:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     176:	15650513          	addi	a0,a0,342 # 12c8 <filter_is_blocked+0x74>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	e24a8a93          	addi	s5,s5,-476 # 12f0 <filter_is_blocked+0x9c>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e2:	df250513          	addi	a0,a0,-526 # 12d0 <filter_is_blocked+0x7c>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     59e:	d5e60613          	addi	a2,a2,-674 # 12f8 <filter_is_blocked+0xa4>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5ce:	d4eb0b13          	addi	s6,s6,-690 # 1318 <filter_is_blocked+0xc4>
  ...
  return ret;
     ...
     5f8:	d0c50513          	addi	a0,a0,-756 # 1300 <filter_is_blocked+0xac>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     64a:	cc250513          	addi	a0,a0,-830 # 1308 <filter_is_blocked+0xb4>
...
000000000000066c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     688:	c9c60613          	addi	a2,a2,-868 # 1320 <filter_is_blocked+0xcc>
     68c:	85ce                	mv	a1,s3
     68e:	854a                	mv	a0,s2
...
00000000000006c6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6e4:	c48a0a13          	addi	s4,s4,-952 # 1328 <filter_is_blocked+0xd4>
  ...
  if(peek(ps, es, ";")){
     ...
     70e:	c2660613          	addi	a2,a2,-986 # 1330 <filter_is_blocked+0xdc>
     712:	85ce                	mv	a1,s3
     714:	854a                	mv	a0,s2
...
000000000000074e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     764:	b9860613          	addi	a2,a2,-1128 # 12f8 <filter_is_blocked+0xa4>
  ...
  if(!peek(ps, es, ")"))
     ...
     788:	bc460613          	addi	a2,a2,-1084 # 1348 <filter_is_blocked+0xf4>
     78c:	85ca                	mv	a1,s2
     78e:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7be:	b7e50513          	addi	a0,a0,-1154 # 1338 <filter_is_blocked+0xe4>
     7c2:	889ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7c6:	00001517          	auipc	a0,0x1
     7ca:	b8a50513          	addi	a0,a0,-1142 # 1350 <filter_is_blocked+0xfc>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     7f2:	bc270713          	addi	a4,a4,-1086 # 13b0 <filter_is_blocked+0x15c>
...
0000000000000852 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     87e:	a0e60613          	addi	a2,a2,-1522 # 1288 <filter_is_blocked+0x34>
     882:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8ac:	ac058593          	addi	a1,a1,-1344 # 1368 <filter_is_blocked+0x114>
     8b0:	4509                	li	a0,2
     8b2:	792000ef          	jal	1044 <fprintf>
    panic("syntax");
     8b6:	00001517          	auipc	a0,0x1
     8ba:	a4a50513          	addi	a0,a0,-1462 # 1300 <filter_is_blocked+0xac>
...
00000000000008c2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8da:	aa248493          	addi	s1,s1,-1374 # 1378 <filter_is_blocked+0x124>
     8de:	4589                	li	a1,2
     8e0:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(cmd[0] == 'c' && cmd[1] == 'd' && cmd[2] == ' '){
     ...
     97e:	a0658593          	addi	a1,a1,-1530 # 1380 <filter_is_blocked+0x12c>
     982:	4509                	li	a0,2
...
printint(int fd, long long xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     d22:	6aa50513          	addi	a0,a0,1706 # 13c8 <digits>
     d26:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fb8:	414b8b93          	addi	s7,s7,1044 # 13c8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    101a:	37a90913          	addi	s2,s2,890 # 1390 <filter_is_blocked+0x13c>
        for(; *s; s++)
...
000000000000121a <filter_enable>:
...
int filter_enable(long blacklist_mask) {
    ...
    1222:	aadff0ef          	jal	cce <setfilter>
}
    1226:	60a2                	ld	ra,8(sp)
    1228:	6402                	ld	s0,0(sp)
    122a:	0141                	addi	sp,sp,16
    122c:	8082                	ret

000000000000122e <filter_add_rule>:
