...
main(int argc, char *argv[])
{
  ...
  40:	90458593          	addi	a1,a1,-1788 # 940 <filter_is_blocked+0x20>
  44:	4509                	li	a0,2
  ...
  56:	90658593          	addi	a1,a1,-1786 # 958 <filter_is_blocked+0x38>
  5a:	4509                	li	a0,2
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3ee:	59650513          	addi	a0,a0,1430 # 980 <digits>
 3f2:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 684:	300b8b93          	addi	s7,s7,768 # 980 <digits>
 ...
 6e6:	29690913          	addi	s2,s2,662 # 978 <filter_is_blocked+0x58>
        for(; *s; s++)
...
00000000000008e6 <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 8ee:	aadff0ef          	jal	39a <setfilter>
}
 8f2:	60a2                	ld	ra,8(sp)
 8f4:	6402                	ld	s0,0(sp)
...
00000000000008fa <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 906:	a9dff0ef          	jal	3a2 <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 90a:	4785                	li	a5,1
 90c:	009797b3          	sll	a5,a5,s1
 910:	8d5d                	or	a0,a0,a5
 912:	a89ff0ef          	jal	39a <setfilter>
}
...
0000000000000920 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 92a:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 92c:	a77ff0ef          	jal	3a2 <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 930:	40955533          	sra	a0,a0,s1
}
 934:	8905                	andi	a0,a0,1
