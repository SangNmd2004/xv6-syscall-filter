...
int main(int argc, char *argv[]) {
  ...
  7a:	368000ef          	jal	3e2 <setfilter>
    uint64 current_mask = getfilter();
  7e:	36c000ef          	jal	3ea <getfilter>
    
    assert(current_mask == test_mask, "Test #2: Check mask application");
  82:	6785                	lui	a5,0x1
  84:	23478793          	addi	a5,a5,564 # 1234 <base+0x224>
  88:	8d1d                	sub	a0,a0,a5
