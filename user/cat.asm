...
cat(int fd)
{
  ...
  3c:	99858593          	addi	a1,a1,-1640 # 9d0 <filter_is_blocked+0x2c>
  40:	4509                	li	a0,2
  ...
  62:	98a58593          	addi	a1,a1,-1654 # 9e8 <filter_is_blocked+0x44>
  66:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
  ...
  da:	92a58593          	addi	a1,a1,-1750 # a00 <filter_is_blocked+0x5c>
  de:	4509                	li	a0,2
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 472:	5b250513          	addi	a0,a0,1458 # a20 <digits>
 476:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 708:	31cb8b93          	addi	s7,s7,796 # a20 <digits>
 ...
 76a:	2b290913          	addi	s2,s2,690 # a18 <filter_is_blocked+0x74>
        for(; *s; s++)
...
000000000000096a <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 972:	aadff0ef          	jal	41e <setfilter>
}
 976:	60a2                	ld	ra,8(sp)
 978:	6402                	ld	s0,0(sp)
...
000000000000097e <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 98a:	a9dff0ef          	jal	426 <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 98e:	4785                	li	a5,1
 990:	009797b3          	sll	a5,a5,s1
 994:	8d5d                	or	a0,a0,a5
 996:	a89ff0ef          	jal	41e <setfilter>
}
...
00000000000009a4 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 9ae:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 9b0:	a77ff0ef          	jal	426 <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 9b4:	40955533          	sra	a0,a0,s1
}
 9b8:	8905                	andi	a0,a0,1
