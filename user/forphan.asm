...
main(int argc, char **argv)
{
  ...
  14:	99050513          	addi	a0,a0,-1648 # 9a0 <filter_is_blocked+0x22>
  ...
  30:	97450513          	addi	a0,a0,-1676 # 9a0 <filter_is_blocked+0x22>
  ...
  42:	96250513          	addi	a0,a0,-1694 # 9a0 <filter_is_blocked+0x22>
  ...
  56:	9ae50513          	addi	a0,a0,-1618 # a00 <filter_is_blocked+0x82>
  ...
  6a:	94a50513          	addi	a0,a0,-1718 # 9b0 <filter_is_blocked+0x32>
  ...
  7c:	95068693          	addi	a3,a3,-1712 # 9c8 <filter_is_blocked+0x4a>
  80:	8626                	mv	a2,s1
  82:	00001597          	auipc	a1,0x1
  86:	94e58593          	addi	a1,a1,-1714 # 9d0 <filter_is_blocked+0x52>
  8a:	4509                	li	a0,2
  ...
  9c:	95050513          	addi	a0,a0,-1712 # 9e8 <filter_is_blocked+0x6a>
  ...
  b2:	96a50513          	addi	a0,a0,-1686 # a18 <filter_is_blocked+0x9a>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 44c:	5f850513          	addi	a0,a0,1528 # a40 <digits>
 450:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6e2:	362b8b93          	addi	s7,s7,866 # a40 <digits>
 ...
 744:	2f890913          	addi	s2,s2,760 # a38 <filter_is_blocked+0xba>
        for(; *s; s++)
...
0000000000000944 <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 94c:	aadff0ef          	jal	3f8 <setfilter>
}
 950:	60a2                	ld	ra,8(sp)
 952:	6402                	ld	s0,0(sp)
...
0000000000000958 <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 964:	a9dff0ef          	jal	400 <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 968:	4785                	li	a5,1
 96a:	009797b3          	sll	a5,a5,s1
 96e:	8d5d                	or	a0,a0,a5
 970:	a89ff0ef          	jal	3f8 <setfilter>
}
