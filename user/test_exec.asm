...
int main() {
   ...
   c:	93850513          	addi	a0,a0,-1736 # 940 <filter_is_blocked+0x2c>
  10:	71e000ef          	jal	72e <printf>
    printf("1. Tien trinh hien tai dang co quyen in an (write).\n");
  14:	00001517          	auipc	a0,0x1
  18:	96450513          	addi	a0,a0,-1692 # 978 <filter_is_blocked+0x64>
  ...
  2e:	9a650513          	addi	a0,a0,-1626 # 9d0 <filter_is_blocked+0xbc>
  ...
  4c:	96850513          	addi	a0,a0,-1688 # 9b0 <filter_is_blocked+0x9c>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3e2:	60250513          	addi	a0,a0,1538 # 9e0 <digits>
 3e6:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 678:	36cb8b93          	addi	s7,s7,876 # 9e0 <digits>
 ...
 6da:	30290913          	addi	s2,s2,770 # 9d8 <filter_is_blocked+0xc4>
        for(; *s; s++)
...
00000000000008da <filter_enable>:
#include "kernel/types.h"
#include "user/user.h"
#include "user/filter.h"
...
int filter_enable(long blacklist_mask) {
 ...
 8e2:	aadff0ef          	jal	38e <setfilter>
}
 8e6:	60a2                	ld	ra,8(sp)
 8e8:	6402                	ld	s0,0(sp)
...
00000000000008ee <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 8fa:	a9dff0ef          	jal	396 <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 8fe:	4785                	li	a5,1
 900:	009797b3          	sll	a5,a5,s1
 904:	8d5d                	or	a0,a0,a5
 906:	a89ff0ef          	jal	38e <setfilter>
}
...
0000000000000914 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 91e:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 920:	a77ff0ef          	jal	396 <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 924:	40955533          	sra	a0,a0,s1
}
 928:	8905                	andi	a0,a0,1
