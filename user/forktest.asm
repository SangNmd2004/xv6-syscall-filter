...
forktest(void)
{
  ...
  36:	3f650513          	addi	a0,a0,1014 # 428 <setfilter_child+0xe>
  ...
  58:	42450513          	addi	a0,a0,1060 # 478 <setfilter_child+0x5e>
  ...
  6e:	3ce50513          	addi	a0,a0,974 # 438 <setfilter_child+0x1e>
  ...
  80:	3d450513          	addi	a0,a0,980 # 450 <setfilter_child+0x36>
  ...
  b0:	3bc50513          	addi	a0,a0,956 # 468 <setfilter_child+0x4e>
...
000000000000041a <setfilter_child>:
