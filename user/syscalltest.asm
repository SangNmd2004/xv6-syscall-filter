...
void test_line(char *name, int num, int res) {
  ...
  18:	a0c50513          	addi	a0,a0,-1524 # a20 <filter_is_blocked+0x24>
  1c:	7fa000ef          	jal	816 <printf>
    printf("%s", name);
  20:	85ce                	mv	a1,s3
  22:	00001517          	auipc	a0,0x1
  26:	a0e50513          	addi	a0,a0,-1522 # a30 <filter_is_blocked+0x34>
  2a:	7ec000ef          	jal	816 <printf>
    printf(" | Num: %d", num);
  2e:	85ca                	mv	a1,s2
  30:	00001517          	auipc	a0,0x1
  34:	a0850513          	addi	a0,a0,-1528 # a38 <filter_is_blocked+0x3c>
  38:	7de000ef          	jal	816 <printf>
    printf(" | Res: %d", res);
  3c:	85a6                	mv	a1,s1
  3e:	00001517          	auipc	a0,0x1
  42:	a0a50513          	addi	a0,a0,-1526 # a48 <filter_is_blocked+0x4c>
  46:	7d0000ef          	jal	816 <printf>
    printf(" | Status: ");
  4a:	00001517          	auipc	a0,0x1
  4e:	a0e50513          	addi	a0,a0,-1522 # a58 <filter_is_blocked+0x5c>
  52:	7c4000ef          	jal	816 <printf>
    if (res >= 0) {
  56:	0004cf63          	bltz	s1,74 <test_line+0x74>
        printf("SUCCESS\n");
  5a:	00001517          	auipc	a0,0x1
  5e:	a0e50513          	addi	a0,a0,-1522 # a68 <filter_is_blocked+0x6c>
  ...
  78:	a0450513          	addi	a0,a0,-1532 # a78 <filter_is_blocked+0x7c>
...
int main(int argc, char *argv[]) {
  ...
  8e:	9f650513          	addi	a0,a0,-1546 # a80 <filter_is_blocked+0x84>
  ...
  a2:	a0a50513          	addi	a0,a0,-1526 # aa8 <filter_is_blocked+0xac>
  ...
  b0:	9c458593          	addi	a1,a1,-1596 # a70 <filter_is_blocked+0x74>
  b4:	4505                	li	a0,1
  ...
  c2:	9f250513          	addi	a0,a0,-1550 # ab0 <filter_is_blocked+0xb4>
  ...
  e0:	9dc50513          	addi	a0,a0,-1572 # ab8 <filter_is_blocked+0xbc>
  ...
  fe:	9c650513          	addi	a0,a0,-1594 # ac0 <filter_is_blocked+0xc4>
 ...
 110:	9b450513          	addi	a0,a0,-1612 # ac0 <filter_is_blocked+0xc4>
 ...
 128:	9a450513          	addi	a0,a0,-1628 # ac8 <filter_is_blocked+0xcc>
 12c:	ed5ff0ef          	jal	0 <test_line>
    }

    printf("--- END SYSCALL BASELINE TEST ---\n");
 130:	00001517          	auipc	a0,0x1
 134:	9a050513          	addi	a0,a0,-1632 # ad0 <filter_is_blocked+0xd4>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 4ca:	63a50513          	addi	a0,a0,1594 # b00 <digits>
 4ce:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 760:	3a4b8b93          	addi	s7,s7,932 # b00 <digits>
 ...
 7c2:	33a90913          	addi	s2,s2,826 # af8 <filter_is_blocked+0xfc>
        for(; *s; s++)
...
00000000000009c2 <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 9ca:	aadff0ef          	jal	476 <setfilter>
}
 9ce:	60a2                	ld	ra,8(sp)
 9d0:	6402                	ld	s0,0(sp)
...
00000000000009d6 <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 9e2:	a9dff0ef          	jal	47e <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 9e6:	4785                	li	a5,1
 9e8:	009797b3          	sll	a5,a5,s1
 9ec:	8d5d                	or	a0,a0,a5
 9ee:	a89ff0ef          	jal	476 <setfilter>
}
...
00000000000009fc <filter_is_blocked>:

int filter_is_blocked(int sys_num) {
 9fc:	1101                	addi	sp,sp,-32
 ...
 a06:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 a08:	a77ff0ef          	jal	47e <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 a0c:	40955533          	sra	a0,a0,s1
}
 a10:	8905                	andi	a0,a0,1
