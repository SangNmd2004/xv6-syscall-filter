   ...
   2:	0ea7df63          	bge	a5,a0,100 <main+0x100>
{
  ...
  3e:	9a650513          	addi	a0,a0,-1626 # 9e0 <filter_is_blocked+0x22>
  ...
  b0:	94c50513          	addi	a0,a0,-1716 # 9f8 <filter_is_blocked+0x3a>
  ...
  c4:	95050513          	addi	a0,a0,-1712 # a10 <filter_is_blocked+0x52>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 48c:	5a850513          	addi	a0,a0,1448 # a30 <digits>
 490:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 722:	312b8b93          	addi	s7,s7,786 # a30 <digits>
 ...
 784:	2a890913          	addi	s2,s2,680 # a28 <filter_is_blocked+0x6a>
        for(; *s; s++)
...
0000000000000984 <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 98c:	aadff0ef          	jal	438 <setfilter>
}
 990:	60a2                	ld	ra,8(sp)
 992:	6402                	ld	s0,0(sp)
...
0000000000000998 <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 9a4:	a9dff0ef          	jal	440 <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 9a8:	4785                	li	a5,1
 9aa:	009797b3          	sll	a5,a5,s1
 9ae:	8d5d                	or	a0,a0,a5
 9b0:	a89ff0ef          	jal	438 <setfilter>
}
...
00000000000009be <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 9c8:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 9ca:	a77ff0ef          	jal	440 <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 9ce:	40955533          	sra	a0,a0,s1
}
 9d2:	8905                	andi	a0,a0,1
