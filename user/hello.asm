...
int main() {
   ...
   e:	8f658593          	addi	a1,a1,-1802 # 900 <filter_is_blocked+0x28>
  12:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3a6:	56e50513          	addi	a0,a0,1390 # 910 <digits>
 3aa:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 63c:	2d8b8b93          	addi	s7,s7,728 # 910 <digits>
 ...
 69e:	26e90913          	addi	s2,s2,622 # 908 <filter_is_blocked+0x30>
        for(; *s; s++)
...
000000000000089e <filter_enable>:
#include "kernel/types.h"
#include "user/user.h"
...
int filter_enable(long blacklist_mask) {
 ...
 8a6:	aadff0ef          	jal	352 <setfilter>
}
 8aa:	60a2                	ld	ra,8(sp)
 8ac:	6402                	ld	s0,0(sp)
...
00000000000008b2 <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 8be:	a9dff0ef          	jal	35a <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 8c2:	4785                	li	a5,1
 8c4:	009797b3          	sll	a5,a5,s1
 8c8:	8d5d                	or	a0,a0,a5
 8ca:	a89ff0ef          	jal	352 <setfilter>
}
...
00000000000008d8 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 8e2:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 8e4:	a77ff0ef          	jal	35a <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 8e8:	40955533          	sra	a0,a0,s1
}
 8ec:	8905                	andi	a0,a0,1
