...
main(int argc, char **argv)
{
  ...
  10:	96450513          	addi	a0,a0,-1692 # 970 <filter_is_blocked+0x2c>
  14:	372000ef          	jal	386 <mkdir>
  18:	c919                	beqz	a0,2e <main+0x2e>
    printf("%s: mkdir dd failed\n", s);
  1a:	85a6                	mv	a1,s1
  1c:	00001517          	auipc	a0,0x1
  20:	95c50513          	addi	a0,a0,-1700 # 978 <filter_is_blocked+0x34>
  ...
  32:	94250513          	addi	a0,a0,-1726 # 970 <filter_is_blocked+0x2c>
  36:	358000ef          	jal	38e <chdir>
  3a:	c919                	beqz	a0,50 <main+0x50>
    printf("%s: chdir dd failed\n", s);
  3c:	85a6                	mv	a1,s1
  3e:	00001517          	auipc	a0,0x1
  42:	95250513          	addi	a0,a0,-1710 # 990 <filter_is_blocked+0x4c>
  ...
  54:	95850513          	addi	a0,a0,-1704 # 9a8 <filter_is_blocked+0x64>
  ...
  64:	96850513          	addi	a0,a0,-1688 # 9c8 <filter_is_blocked+0x84>
  ...
  7c:	93850513          	addi	a0,a0,-1736 # 9b0 <filter_is_blocked+0x6c>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 412:	5e250513          	addi	a0,a0,1506 # 9f0 <digits>
 416:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6a8:	34cb8b93          	addi	s7,s7,844 # 9f0 <digits>
 ...
 70a:	2e290913          	addi	s2,s2,738 # 9e8 <filter_is_blocked+0xa4>
        for(; *s; s++)
...
000000000000090a <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 912:	aadff0ef          	jal	3be <setfilter>
}
 916:	60a2                	ld	ra,8(sp)
 918:	6402                	ld	s0,0(sp)
...
000000000000091e <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 92a:	a9dff0ef          	jal	3c6 <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 92e:	4785                	li	a5,1
 930:	009797b3          	sll	a5,a5,s1
 934:	8d5d                	or	a0,a0,a5
 936:	a89ff0ef          	jal	3be <setfilter>
}
...
0000000000000944 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 94e:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 950:	a77ff0ef          	jal	3c6 <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 954:	40955533          	sra	a0,a0,s1
}
 958:	8905                	andi	a0,a0,1
