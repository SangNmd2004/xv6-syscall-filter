...
main(int argc, char *argv[])
{
  ...
  34:	9e0a8a93          	addi	s5,s5,-1568 # a10 <filter_debug_status+0x9a>
  ...
  6a:	9b258593          	addi	a1,a1,-1614 # a18 <filter_debug_status+0xa2>
  6e:	4505                	li	a0,1
...
00000000000003be <setfilter_child>:
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 402:	6f250513          	addi	a0,a0,1778 # af0 <digits>
 406:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 698:	45cb8b93          	addi	s7,s7,1116 # af0 <digits>
 ...
 6fa:	32a90913          	addi	s2,s2,810 # a20 <filter_debug_status+0xaa>
        for(; *s; s++)
...
free(void *ap)
{
 ...
 78a:	00002797          	auipc	a5,0x2
 78e:	8767b783          	ld	a5,-1930(a5) # 2000 <freep>
 ...
 7b6:	00e6ea63          	bltu	a3,a4,7ca <free+0x4a>
{
 ...
 7f2:	e394                	sd	a3,0(a5)
    ...
    p->s.ptr = bp;
  freep = p;
 7f4:	00002717          	auipc	a4,0x2
 7f8:	80f73623          	sd	a5,-2036(a4) # 2000 <freep>
}
 7fc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 822:	7e253503          	ld	a0,2018(a0) # 2000 <freep>
 ...
 852:	7b290913          	addi	s2,s2,1970 # 2000 <freep>
  if(p == SBRK_ERROR)
 856:	5afd                	li	s5,-1
 ...
 866:	7ae78793          	addi	a5,a5,1966 # 2010 <base>
 86a:	00001717          	auipc	a4,0x1
 86e:	78f73b23          	sd	a5,1942(a4) # 2000 <freep>
 872:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8dc:	72a73423          	sd	a0,1832(a4) # 2000 <freep>
      return (void*)(p + 1);
...
int filter_apply(long blacklist_mask) {
 ...
 902:	fff54513          	not	a0,a0
 906:	aa9ff0ef          	jal	3ae <setfilter>
}
 90a:	60a2                	ld	ra,8(sp)
 90c:	6402                	ld	s0,0(sp)
...
0000000000000912 <filter_block_syscall>:
...
int filter_block_syscall(int sys_num) {
 ...
 91e:	a99ff0ef          	jal	3b6 <getfilter>
    // Tắt bit tương ứng với syscall đó trong whitelist
    return setfilter(current_mask & ~BLOCK(sys_num));
 922:	4785                	li	a5,1
 924:	009797b3          	sll	a5,a5,s1
 928:	fff7c793          	not	a5,a5
 92c:	8d7d                	and	a0,a0,a5
 92e:	a81ff0ef          	jal	3ae <setfilter>
}
...
int filter_reset(void) {
 ...
 944:	557d                	li	a0,-1
 946:	a69ff0ef          	jal	3ae <setfilter>
}
 94a:	60a2                	ld	ra,8(sp)
 94c:	6402                	ld	s0,0(sp)
...
0000000000000952 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 95c:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 95e:	a59ff0ef          	jal	3b6 <getfilter>
    return !(current_mask & BLOCK(sys_num));
 962:	40955533          	sra	a0,a0,s1
 966:	00154513          	xori	a0,a0,1
}
 96a:	8905                	andi	a0,a0,1
...
0000000000000976 <filter_debug_status>:
...
void filter_debug_status(void) {
 ...
 97e:	1000                	addi	s0,sp,32
    long m = getfilter();
 980:	a37ff0ef          	jal	3b6 <getfilter>
 984:	84aa                	mv	s1,a0
    printf("\n[Sandbox Monitor]\n");
 986:	00000517          	auipc	a0,0x0
 98a:	0d250513          	addi	a0,a0,210 # a58 <filter_debug_status+0xe2>
 98e:	dc1ff0ef          	jal	74e <printf>
    printf("Whitelist Mask: %ld\n", m);
 992:	85a6                	mv	a1,s1
 994:	00000517          	auipc	a0,0x0
 998:	0dc50513          	addi	a0,a0,220 # a70 <filter_debug_status+0xfa>
 99c:	db3ff0ef          	jal	74e <printf>
    printf("Security Level: %s\n", (m == 0xFFFFFFFFFFFFFFFFL) ? "LOW (Permissive)" : "HIGH (Restricted)");
 9a0:	57fd                	li	a5,-1
 9a2:	00000597          	auipc	a1,0x0
 9a6:	09e58593          	addi	a1,a1,158 # a40 <filter_debug_status+0xca>
 9aa:	02f48b63          	beq	s1,a5,9e0 <filter_debug_status+0x6a>
 9ae:	00000517          	auipc	a0,0x0
 9b2:	0da50513          	addi	a0,a0,218 # a88 <filter_debug_status+0x112>
 9b6:	d99ff0ef          	jal	74e <printf>
    
    if(filter_is_blocked(SYS_open)) printf(" - File access: LOCKED\n");
 9ba:	453d                	li	a0,15
 9bc:	f97ff0ef          	jal	952 <filter_is_blocked>
 9c0:	e50d                	bnez	a0,9ea <filter_debug_status+0x74>
    if(filter_is_blocked(SYS_fork)) printf(" - Process creation: LOCKED\n");
 9c2:	4505                	li	a0,1
 9c4:	f8fff0ef          	jal	952 <filter_is_blocked>
 9c8:	e905                	bnez	a0,9f8 <filter_debug_status+0x82>
    printf("------------------\n");
 9ca:	00000517          	auipc	a0,0x0
 9ce:	10e50513          	addi	a0,a0,270 # ad8 <filter_debug_status+0x162>
 9d2:	d7dff0ef          	jal	74e <printf>
 ...
 9e4:	04858593          	addi	a1,a1,72 # a28 <filter_debug_status+0xb2>
 9e8:	b7d9                	j	9ae <filter_debug_status+0x38>
    if(filter_is_blocked(SYS_open)) printf(" - File access: LOCKED\n");
 9ea:	00000517          	auipc	a0,0x0
 9ee:	0b650513          	addi	a0,a0,182 # aa0 <filter_debug_status+0x12a>
 9f2:	d5dff0ef          	jal	74e <printf>
 9f6:	b7f1                	j	9c2 <filter_debug_status+0x4c>
    if(filter_is_blocked(SYS_fork)) printf(" - Process creation: LOCKED\n");
 9f8:	00000517          	auipc	a0,0x0
 9fc:	0c050513          	addi	a0,a0,192 # ab8 <filter_debug_status+0x142>
 a00:	d4fff0ef          	jal	74e <printf>
 a04:	b7d9                	j	9ca <filter_debug_status+0x54>
