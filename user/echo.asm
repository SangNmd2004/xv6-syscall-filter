...
main(int argc, char *argv[])
{
  ...
  34:	930a8a93          	addi	s5,s5,-1744 # 960 <filter_is_blocked+0x2c>
  ...
  6a:	90258593          	addi	a1,a1,-1790 # 968 <filter_is_blocked+0x34>
  6e:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 402:	57a50513          	addi	a0,a0,1402 # 978 <digits>
 406:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 698:	2e4b8b93          	addi	s7,s7,740 # 978 <digits>
 ...
 6fa:	27a90913          	addi	s2,s2,634 # 970 <filter_is_blocked+0x3c>
        for(; *s; s++)
...
00000000000008fa <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 902:	aadff0ef          	jal	3ae <setfilter>
}
 906:	60a2                	ld	ra,8(sp)
 908:	6402                	ld	s0,0(sp)
...
000000000000090e <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 91a:	a9dff0ef          	jal	3b6 <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 91e:	4785                	li	a5,1
 920:	009797b3          	sll	a5,a5,s1
 924:	8d5d                	or	a0,a0,a5
 926:	a89ff0ef          	jal	3ae <setfilter>
}
...
0000000000000934 <filter_is_blocked>:
