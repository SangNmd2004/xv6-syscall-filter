...
00000000000001c4 <main>:
{
 ...
 226:	91e58593          	addi	a1,a1,-1762 # b40 <filter_is_blocked+0x2c>
 22a:	4509                	li	a0,2
 ...
 24c:	91850513          	addi	a0,a0,-1768 # b60 <filter_is_blocked+0x4c>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 5e2:	5a250513          	addi	a0,a0,1442 # b80 <digits>
 5e6:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 878:	30cb8b93          	addi	s7,s7,780 # b80 <digits>
 ...
 8da:	2a290913          	addi	s2,s2,674 # b78 <filter_is_blocked+0x64>
        for(; *s; s++)
...
0000000000000ada <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 ae2:	aadff0ef          	jal	58e <setfilter>
}
 ae6:	60a2                	ld	ra,8(sp)
 ae8:	6402                	ld	s0,0(sp)
...
0000000000000aee <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 afa:	a9dff0ef          	jal	596 <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 afe:	4785                	li	a5,1
 b00:	009797b3          	sll	a5,a5,s1
 b04:	8d5d                	or	a0,a0,a5
 b06:	a89ff0ef          	jal	58e <setfilter>
}
...
0000000000000b14 <filter_is_blocked>:

int filter_is_blocked(int sys_num) {
 b14:	1101                	addi	sp,sp,-32
 ...
 b1e:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 b20:	a77ff0ef          	jal	596 <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 b24:	40955533          	sra	a0,a0,s1
}
 b28:	8905                	andi	a0,a0,1
