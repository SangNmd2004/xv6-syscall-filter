...
main(int argc, char *argv[])
{
  ...
  1a:	a8a78793          	addi	a5,a5,-1398 # aa0 <filter_debug_status+0xcc>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	a4450513          	addi	a0,a0,-1468 # a70 <filter_debug_status+0x9c>
  ...
  60:	a2c50513          	addi	a0,a0,-1492 # a88 <filter_debug_status+0xb4>
...
//    printf(fd, "%d\n", i);
  ...
  9e:	9fe50513          	addi	a0,a0,-1538 # a98 <filter_debug_status+0xc4>
...
000000000000041c <setfilter_child>:
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 460:	72450513          	addi	a0,a0,1828 # b80 <digits>
 464:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6f6:	48eb8b93          	addi	s7,s7,1166 # b80 <digits>
 ...
 758:	35c90913          	addi	s2,s2,860 # ab0 <filter_debug_status+0xdc>
        for(; *s; s++)
...
free(void *ap)
{
 ...
 7ec:	8187b783          	ld	a5,-2024(a5) # 2000 <freep>
 ...
 814:	00e6ea63          	bltu	a3,a4,828 <free+0x4a>
{
 ...
 856:	7af73723          	sd	a5,1966(a4) # 2000 <freep>
}
 85a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 880:	78453503          	ld	a0,1924(a0) # 2000 <freep>
 ...
 8b0:	75490913          	addi	s2,s2,1876 # 2000 <freep>
  if(p == SBRK_ERROR)
 8b4:	5afd                	li	s5,-1
 ...
 8c4:	75078793          	addi	a5,a5,1872 # 2010 <base>
 8c8:	00001717          	auipc	a4,0x1
 8cc:	72f73c23          	sd	a5,1848(a4) # 2000 <freep>
 8d0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 93a:	6ca73523          	sd	a0,1738(a4) # 2000 <freep>
      return (void*)(p + 1);
...
int filter_apply(long blacklist_mask) {
 ...
 960:	fff54513          	not	a0,a0
 964:	aa9ff0ef          	jal	40c <setfilter>
}
 968:	60a2                	ld	ra,8(sp)
 96a:	6402                	ld	s0,0(sp)
...
0000000000000970 <filter_block_syscall>:
...
int filter_reset(void) {
 ...
 9a2:	557d                	li	a0,-1
 9a4:	a69ff0ef          	jal	40c <setfilter>
}
 9a8:	60a2                	ld	ra,8(sp)
 9aa:	6402                	ld	s0,0(sp)
...
00000000000009b0 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 9ba:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 9bc:	a59ff0ef          	jal	414 <getfilter>
    return !(current_mask & BLOCK(sys_num));
 9c0:	40955533          	sra	a0,a0,s1
 9c4:	00154513          	xori	a0,a0,1
}
 9c8:	8905                	andi	a0,a0,1
...
00000000000009d4 <filter_debug_status>:
...
void filter_debug_status(void) {
 ...
 9dc:	1000                	addi	s0,sp,32
    long m = getfilter();
 9de:	a37ff0ef          	jal	414 <getfilter>
 9e2:	84aa                	mv	s1,a0
    printf("\n[Sandbox Monitor]\n");
 9e4:	00000517          	auipc	a0,0x0
 9e8:	10450513          	addi	a0,a0,260 # ae8 <filter_debug_status+0x114>
 9ec:	dc1ff0ef          	jal	7ac <printf>
    printf("Whitelist Mask: %ld\n", m);
 9f0:	85a6                	mv	a1,s1
 9f2:	00000517          	auipc	a0,0x0
 9f6:	10e50513          	addi	a0,a0,270 # b00 <filter_debug_status+0x12c>
 9fa:	db3ff0ef          	jal	7ac <printf>
    printf("Security Level: %s\n", (m == 0xFFFFFFFFFFFFFFFFL) ? "LOW (Permissive)" : "HIGH (Restricted)");
 9fe:	57fd                	li	a5,-1
 a00:	00000597          	auipc	a1,0x0
 a04:	0d058593          	addi	a1,a1,208 # ad0 <filter_debug_status+0xfc>
 a08:	02f48b63          	beq	s1,a5,a3e <filter_debug_status+0x6a>
 a0c:	00000517          	auipc	a0,0x0
 a10:	10c50513          	addi	a0,a0,268 # b18 <filter_debug_status+0x144>
 a14:	d99ff0ef          	jal	7ac <printf>
    
    if(filter_is_blocked(SYS_open)) printf(" - File access: LOCKED\n");
 a18:	453d                	li	a0,15
 a1a:	f97ff0ef          	jal	9b0 <filter_is_blocked>
 a1e:	e50d                	bnez	a0,a48 <filter_debug_status+0x74>
    if(filter_is_blocked(SYS_fork)) printf(" - Process creation: LOCKED\n");
 a20:	4505                	li	a0,1
 a22:	f8fff0ef          	jal	9b0 <filter_is_blocked>
 a26:	e905                	bnez	a0,a56 <filter_debug_status+0x82>
    printf("------------------\n");
 a28:	00000517          	auipc	a0,0x0
 a2c:	14050513          	addi	a0,a0,320 # b68 <filter_debug_status+0x194>
 a30:	d7dff0ef          	jal	7ac <printf>
 ...
 a42:	07a58593          	addi	a1,a1,122 # ab8 <filter_debug_status+0xe4>
 a46:	b7d9                	j	a0c <filter_debug_status+0x38>
    if(filter_is_blocked(SYS_open)) printf(" - File access: LOCKED\n");
 a48:	00000517          	auipc	a0,0x0
 a4c:	0e850513          	addi	a0,a0,232 # b30 <filter_debug_status+0x15c>
 a50:	d5dff0ef          	jal	7ac <printf>
 a54:	b7f1                	j	a20 <filter_debug_status+0x4c>
    if(filter_is_blocked(SYS_fork)) printf(" - Process creation: LOCKED\n");
 a56:	00000517          	auipc	a0,0x0
 a5a:	0f250513          	addi	a0,a0,242 # b48 <filter_debug_status+0x174>
 a5e:	d4fff0ef          	jal	7ac <printf>
 a62:	b7d9                	j	a28 <filter_debug_status+0x54>
