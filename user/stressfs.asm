...
main(int argc, char *argv[])
{
  ...
  1a:	9da78793          	addi	a5,a5,-1574 # 9f0 <filter_is_blocked+0x5e>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	99450513          	addi	a0,a0,-1644 # 9c0 <filter_is_blocked+0x2e>
  ...
  60:	97c50513          	addi	a0,a0,-1668 # 9d8 <filter_is_blocked+0x46>
...
//    printf(fd, "%d\n", i);
  ...
  9e:	94e50513          	addi	a0,a0,-1714 # 9e8 <filter_is_blocked+0x56>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 460:	5ac50513          	addi	a0,a0,1452 # a08 <digits>
 464:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6f6:	316b8b93          	addi	s7,s7,790 # a08 <digits>
 ...
 758:	2ac90913          	addi	s2,s2,684 # a00 <filter_is_blocked+0x6e>
        for(; *s; s++)
...
0000000000000958 <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 960:	aadff0ef          	jal	40c <setfilter>
}
 964:	60a2                	ld	ra,8(sp)
 966:	6402                	ld	s0,0(sp)
...
000000000000096c <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 978:	a9dff0ef          	jal	414 <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 97c:	4785                	li	a5,1
 97e:	009797b3          	sll	a5,a5,s1
 982:	8d5d                	or	a0,a0,a5
 984:	a89ff0ef          	jal	40c <setfilter>
}
...
0000000000000992 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 99c:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 99e:	a77ff0ef          	jal	414 <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 9a2:	40955533          	sra	a0,a0,s1
}
 9a6:	8905                	andi	a0,a0,1
