...
void test_read(char *name) {
  ...
  12:	9f250513          	addi	a0,a0,-1550 # a00 <filter_is_blocked+0x2e>
  ...
  36:	a1e50513          	addi	a0,a0,-1506 # a50 <filter_is_blocked+0x7e>
  ...
  56:	9be50513          	addi	a0,a0,-1602 # a10 <filter_is_blocked+0x3e>
  ...
  66:	9ce50513          	addi	a0,a0,-1586 # a30 <filter_is_blocked+0x5e>
...
int main() {
  ...
  7c:	a0050513          	addi	a0,a0,-1536 # a78 <filter_is_blocked+0xa6>
  ...
  94:	a3850513          	addi	a0,a0,-1480 # ac8 <filter_is_blocked+0xf6>
  98:	754000ef          	jal	7ec <printf>

    // 2. Cha tu kiem tra xem minh co bi anh huong khong
    printf("Cha: Dang thu doc file...\n");
  9c:	00001517          	auipc	a0,0x1
  a0:	a5450513          	addi	a0,a0,-1452 # af0 <filter_is_blocked+0x11e>
  a4:	748000ef          	jal	7ec <printf>
    test_read("Cha");
  a8:	00001517          	auipc	a0,0x1
  ac:	a6850513          	addi	a0,a0,-1432 # b10 <filter_is_blocked+0x13e>
  ...
  c2:	a6a50513          	addi	a0,a0,-1430 # b28 <filter_is_blocked+0x156>
  c6:	726000ef          	jal	7ec <printf>
        test_read("Con");
  ca:	00001517          	auipc	a0,0x1
  ce:	a9650513          	addi	a0,a0,-1386 # b60 <filter_is_blocked+0x18e>
  ...
  e0:	9c450513          	addi	a0,a0,-1596 # aa0 <filter_is_blocked+0xce>
  ...
  f2:	a2a50513          	addi	a0,a0,-1494 # b18 <filter_is_blocked+0x146>
 ...
 10a:	a6250513          	addi	a0,a0,-1438 # b68 <filter_is_blocked+0x196>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 4a0:	6ec50513          	addi	a0,a0,1772 # b88 <digits>
 4a4:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 736:	456b8b93          	addi	s7,s7,1110 # b88 <digits>
 ...
 798:	3ec90913          	addi	s2,s2,1004 # b80 <filter_is_blocked+0x1ae>
        for(; *s; s++)
...
0000000000000998 <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 9a0:	aadff0ef          	jal	44c <setfilter>
}
 9a4:	60a2                	ld	ra,8(sp)
 9a6:	6402                	ld	s0,0(sp)
...
00000000000009ac <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 9b8:	a9dff0ef          	jal	454 <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 9bc:	4785                	li	a5,1
 9be:	009797b3          	sll	a5,a5,s1
 9c2:	8d5d                	or	a0,a0,a5
 9c4:	a89ff0ef          	jal	44c <setfilter>
}
...
00000000000009d2 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 9dc:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 9de:	a77ff0ef          	jal	454 <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 9e2:	40955533          	sra	a0,a0,s1
}
 9e6:	8905                	andi	a0,a0,1
