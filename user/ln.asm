...
main(int argc, char *argv[])
{
  ...
  14:	92058593          	addi	a1,a1,-1760 # 930 <filter_is_blocked+0x28>
  18:	4509                	li	a0,2
  ...
  42:	90a58593          	addi	a1,a1,-1782 # 948 <filter_is_blocked+0x40>
  46:	4509                	li	a0,2
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3d6:	59650513          	addi	a0,a0,1430 # 968 <digits>
 3da:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 66c:	300b8b93          	addi	s7,s7,768 # 968 <digits>
 ...
 6ce:	29690913          	addi	s2,s2,662 # 960 <filter_is_blocked+0x58>
        for(; *s; s++)
...
00000000000008ce <filter_enable>:
...
int filter_enable(long blacklist_mask) {
 ...
 8d6:	aadff0ef          	jal	382 <setfilter>
}
 8da:	60a2                	ld	ra,8(sp)
 8dc:	6402                	ld	s0,0(sp)
...
00000000000008e2 <filter_add_rule>:
...
int filter_add_rule(int sys_num) {
 ...
 8ee:	a9dff0ef          	jal	38a <getfilter>
    return setfilter(current_mask | BLOCK(sys_num));
 8f2:	4785                	li	a5,1
 8f4:	009797b3          	sll	a5,a5,s1
 8f8:	8d5d                	or	a0,a0,a5
 8fa:	a89ff0ef          	jal	382 <setfilter>
}
...
0000000000000908 <filter_is_blocked>:
...
int filter_is_blocked(int sys_num) {
 ...
 912:	84aa                	mv	s1,a0
    long current_mask = getfilter();
 914:	a77ff0ef          	jal	38a <getfilter>
    return (current_mask & BLOCK(sys_num)) != 0;
 918:	40955533          	sra	a0,a0,s1
}
 91c:	8905                	andi	a0,a0,1
